...
@Component
@Scope("prototype")
public class AutoGeneratePreSaleTasks extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    @StepNo(stepNo = 1)
    protected void autoGeneratePreSaleTasks(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 售前登记公告任务自动生成 Start -----------");

        Map<String, Object> param = new HashMap<String, Object>();
        param.put("prodBaseDate",request.getTaskDate());
        Object body=ServerUtil.requestPost("PmsApp", "com.kayak.pms.disclosureControl.model.DisclosureProdTask", "autoGenerateBeforeSaleTask", param);
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 售前登记公告任务自动生成 End-----------");
    }
