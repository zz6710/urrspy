...
//@Component
//@Scope("prototype")
//public class PrdSpvsInfService extends BaseTaskService<PubReq, PubResp> {
//
//    @Autowired
...
//
//    @StepNo(stepNo = 1)
//    protected void dealPordCbrdat(PubReq request) throws Exception{
//        //
//        String sysDate = DateUtil.getSysWordDay();
//        log.info("----------产品监管信息模型生成Start -----------");
//        String insertString=ExeQuery.queryExeId("IT01PRODCBR");
//        String deleteString=ExeQuery.queryExeId("DE01PRODCBR");
