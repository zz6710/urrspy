...
//@Component
//@Scope("prototype")
//public class CustLotPosDtlService extends BaseTaskService<PubReq, PubResp> {
//
//    @Autowired
...
//
//    @StepNo(stepNo = 1)
//    protected void dealVolBalanceSum(PubReq request) throws Exception{
//        //直接使用insertselect 写法
//        String sysDate = DateUtil.getSysWordDay();
//        log.info("----------客户份额持仓明细模型生成Start -----------");
//        String insertString= ExeQuery.queryExeId("IT05VOLBALSUM");
//        String deleteString=ExeQuery.queryExeId("DE05VOLBALSUM");
