...
@Component
@Scope("prototype")
public class NavInfoReportIndexValidationService extends BaseTaskService<PubReq, PubResp> {

    private static Logger log = LoggerFactory.getLogger(NavInfoReportIndexValidationService.class);
    ...
    protected void step1Process(PubReq request) throws Exception {
        ...
        log.info("---------- " + task_id + "净值信息登记报送指标校验:任务 执行结束 -----------");
    }
