...
//@Component
//@Scope("prototype")
//public class BondCrdRatService extends BaseTaskService<PubReq, PubResp> {
//
//    private static Logger log = LoggerFactory.getLogger(BondCrdRatService.class);
//
//    @Autowired
...
//        log.info("---------- 债券信用评级数据:贴源层-->模型层:任务 Start -----------");
//        try {
//            Map<String, Object> params=new HashMap<>();
//            params.put("deal_date",DateUtil.getSysWordDay());//系统工作日
//            //执行语句先删后插
//            comnDao.update(ExeQuery.queryExeId("DELMDLBONDRATINGEQ01"), params);
//            comnDao.update(ExeQuery.queryExeId("ITMDLBONDRATINGEQ01"), params);
//            log.info("---------- 债券信用评级数据:贴源层-->模型层:任务 End -----------");
//        } catch (Exception e) {
//            throw new ModelDataHandleException("贴源层加工债券信用评级数据异常:" + e.getMessage());
//        }
//
//    }
//
