...
//@Component
//@Scope("prototype")
//public class CustBasInfService extends BaseTaskService<PubReq, PubResp> {
//
//    @Autowired
...
//
//    @StepNo(stepNo = 1)
//    protected void dealInvestorIdentity(PubReq request) throws Exception{
//        //直接使用insertselect 写法
//        String sysDate = DateUtil.getSysWordDay();
//        log.info("----------客户基本信息模型生成Start -----------");
//        String insertString= ExeQuery.queryExeId("IT03INVEIDE");
//        String deleteString=ExeQuery.queryExeId("DE03INVEIDE");
