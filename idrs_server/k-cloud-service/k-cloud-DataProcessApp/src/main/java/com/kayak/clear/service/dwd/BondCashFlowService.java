...
//@Component
//@Scope("prototype")
//public class BondCashFlowService extends BaseTaskService<PubReq, PubResp> {
//
//    private static Logger log = LoggerFactory.getLogger(BondCashFlowService.class);
//
//    @Autowired
...
//        log.info("---------- 债券现金流数据:贴源层-->模型层:任务 Start -----------");
//        try {
//            Map<String, Object> params=new HashMap<>();
//            params.put("deal_date", DateUtil.getSysWordDay());
//            //执行语句先删后插
//            comnDao.update(ExeQuery.queryExeId("DELMDLBONDCASHEQ01"), params);
//            comnDao.update(ExeQuery.queryExeId("ITMDLBONDCASHEQ01"), params);
//            log.info("---------- 债券现金流数据:贴源层-->模型层:任务 End -----------");
//        } catch (Exception e) {
//            throw new ModelDataHandleException("贴源层加工债券现金流数据异常:" + e.getMessage());
//        }
//
//    }
//
