...
@Component
@Scope("prototype")
public class AutoGenerateNetTasks extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    @StepNo(stepNo = 1)
    protected void autoGenerateNetTasks(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 净值公告任务自动生成 Start -----------");

        Map<String, Object> param = new HashMap<String, Object>();
        param.put("prodBaseDate",request.getTaskDate());
        Object body=ServerUtil.requestPost("PmsApp", "com.kayak.pms.disclosureControl.model.DisclosureProdTask", "autoGenerateNetTask", param);
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 净值公告任务自动生成 End-----------");
    }
