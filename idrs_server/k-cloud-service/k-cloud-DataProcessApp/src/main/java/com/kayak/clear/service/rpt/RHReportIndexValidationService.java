...
@Component
@Scope("prototype")
public class RHReportIndexValidationService extends BaseTaskService<PubReq, PubResp> {

    private static Logger log = LoggerFactory.getLogger(RHReportIndexValidationService.class);
    ...
    protected void step1Process(PubReq request) throws Exception {
        ...
        log.info("---------- " + task_id + "人行金融机构资产管理产品报告指标校验:任务 执行结束 -----------");
    }
