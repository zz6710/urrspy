...
@Component
@Scope("prototype")
public class AutoBatchSendNetNotice extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    @StepNo(stepNo = 1)
    protected void autoBatchSendNetNotice(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 净值报告公告自动批量发布 Start -----------");
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 净值报告公告自动批量发布 End-----------");
    }
