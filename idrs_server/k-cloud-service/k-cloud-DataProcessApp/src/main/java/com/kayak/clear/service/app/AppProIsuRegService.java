//package com.kayak.clear.service.app;
//
//
...
//import com.kayak.core.util.//import com.kayak.core.util.DateUtil;;
...
//@Component
//@Scope("prototype")
//public class AppProIsuRegService extends BaseTaskService<PubReq, PubResp> {
//
//    @Autowired
...
//
//    @StepNo(stepNo = 1)
//    protected void dealAppPordNavInfo(PubReq request) throws Exception{
//        //直接使用insertselect 写法
//        String sysDate = //import com.kayak.core.util.DateUtil;.getSysWordDay();
//        log.info("----------APP产品登记发行模型生成Start -----------");
//        String insertString= ExeQuery.queryExeId("INSERT03APP_PRD_ISU_REG");
//        String deleteString=ExeQuery.queryExeId("DELETE03APP_PRD_ISU_REG");
