...
@Component
@Scope("prototype")
public class AutoBatchGenerateBonusData extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    ...
    protected void autoBatchGenerateIssueData(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 分红公告自动生成 Start -----------");

        Map<String, Object> param = new HashMap<String, Object>();
        param.put("disclosureType","10");
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 分红公告自动生成 End-----------");
    }
