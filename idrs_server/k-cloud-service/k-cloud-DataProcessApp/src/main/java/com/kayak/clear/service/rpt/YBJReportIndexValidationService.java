...
@Component
@Scope("prototype")
public class YBJReportIndexValidationService extends BaseTaskService<PubReq, PubResp> {

    private static Logger log = LoggerFactory.getLogger(YBJReportIndexValidationService.class);
    ...
    protected void step1Process(PubReq request) throws Exception {
        ...
        log.info("---------- " + task_id + "银保监报表报送指标校验:任务 执行结束 -----------");
    }
