...
//@Component
//@Scope("prototype")
//public class PrdFeePayDtlService extends BaseTaskService<PubReq, PubResp> {
//
//    @Autowired
...
//
//    @StepNo(stepNo = 1)
//    protected void dealProdPayDetails(PubReq request) throws Exception{
//        //直接使用insertselect 写法
//        String sysDate = DateUtil.getSysWordDay();
//        log.info("----------产品费用支付明细模型生成Start -----------");
//        String insertString= ExeQuery.queryExeId("IT10PRODPAYDET");
//        String deleteString=ExeQuery.queryExeId("DE10PRODPAYDET");
