...
@Component
@Scope("prototype")
public class CispSendDataService extends BaseTaskService<PubReq, PubResp> {

    private static Logger log = LoggerFactory.getLogger(CispSendDataService.class);
