...
@Component
@Scope("prototype")
public class AutoBatchGenerateExpireData extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    @StepNo(stepNo = 1)
    protected void autoBatchGenerateExpireData(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 到期公告自动生成 Start -----------");

        Map<String, Object> param = new HashMap<String, Object>();
        param.put("disclosureType","3");
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 到期公告自动生成 End-----------");
    }
