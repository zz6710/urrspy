...
@Component
@Scope("prototype")
public class AutoBatchGenerateWholeData extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    @StepNo(stepNo = 1)
    protected void autoBatchGenerateWholeData(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 整体报告自动生成 Start -----------");

        Map<String, Object> param = new HashMap<String, Object>();
        param.put("disclosureType","6");
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 整体报告自动生成 End-----------");
    }
