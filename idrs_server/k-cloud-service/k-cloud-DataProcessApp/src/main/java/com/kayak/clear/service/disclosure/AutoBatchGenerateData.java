...
@Component
@Scope("prototype")
public class AutoBatchGenerateData extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    @StepNo(stepNo = 1)
    protected void autoBatchGenerateData(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 公告自动生成 Start -----------");
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 公告自动生成 End-----------");
    }
