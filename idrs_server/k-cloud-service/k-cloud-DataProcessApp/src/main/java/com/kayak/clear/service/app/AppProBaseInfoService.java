...
//@Component
//@Scope("prototype")
//public class AppProBaseInfoService extends BaseTaskService<PubReq, PubResp> {
//
//    @Autowired
...
//
//    @StepNo(stepNo = 1)
//    protected void dealAppPordBaseInfo(PubReq request) throws Exception{
//        //直接使用insertselect 写法
//        String sysDate = DateUtil.getSysWordDay();
//        log.info("----------产品基本信息模型生成Start -----------");
//        String insertString= ExeQuery.queryExeId("INSERT01APP_PRD_BAS_INF");
//        String deleteString=ExeQuery.queryExeId("DELETE01APP_PRD_BAS_INF");
