...
@Component
@Scope("prototype")
public class AutoBatchSendIssueNotice extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    @StepNo(stepNo = 1)
    protected void autoBatchSendIssueNotice(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 公告自动批量发布 Start -----------");
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 公告自动批量发布 End-----------");
    }
