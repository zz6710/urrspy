...
//@Component
//@Scope("prototype")
//public class ProdSaleDtlService extends BaseTaskService<PubReq, PubResp> {
//
//    private static Logger log = LoggerFactory.getLogger(ProdSaleDtlService.class);
//
//    @Autowired
...
//            log.info("----------产品销售明细汇总模型生成Start -----------");
//            String insertString=ExeQuery.queryExeId("IT13PROSALDEL");
//            String deleteString=ExeQuery.queryExeId("DE13PROSALDEL");
