...
@Component
@Scope("prototype")
public class StgCspDataService extends BaseTaskService<PubReq, PubResp> {

    private static Logger log = LoggerFactory.getLogger(StgCspDataService.class);
