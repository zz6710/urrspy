...
@Component
@Scope("prototype")
public class AutoGenerateSaleTasks extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    @StepNo(stepNo = 1)
    protected void autoGenerateSaleTasks(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 销售文档任务自动生成 Start -----------");

        Map<String, Object> param = new HashMap<String, Object>();
        param.put("prodBaseDate",request.getTaskDate());
        Object body=ServerUtil.requestPost("PmsApp", "com.kayak.pms.disclosureControl.model.DisclosureProdTask", "autoGenerateSaleTask", param);
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 销售文档任务自动生成 End-----------");
    }
