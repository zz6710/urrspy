...
//@Component
//@Scope("prototype")
//public class PrdPfmCompInfService extends BaseTaskService<PubReq, PubResp> {
//
//    @Autowired
...
//
//    @StepNo(stepNo = 1)
//    protected void dealPordDfmCompBchmDtl(PubReq request) throws Exception{
//        //直接使用insertselect 写法
//        String sysDate = DateUtil.getSysWordDay();
//        log.info("----------产品业绩比较基准明细模型生成Start -----------");
//        String insertString= ExeQuery.queryExeId("IT11PRODDFMCOMP");
//        String deleteString=ExeQuery.queryExeId("DE11RODDFMCOMP");
