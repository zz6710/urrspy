...
//@Component
//@Scope("prototype")
//public class PrdFeeInfService extends BaseTaskService<PubReq, PubResp> {
//
//    @Autowired
...
//
//    @StepNo(stepNo = 1)
//    protected void dealProdFeeInfo(PubReq request) throws Exception{
//        //直接使用insertselect 写法
//        String sysDate = DateUtil.getSysWordDay();
//        log.info("----------产品费用信息模型生成Start -----------");
//        String insertString= ExeQuery.queryExeId("IT07PRODFEE");
//        String deleteString=ExeQuery.queryExeId("DE07PRODFEE");
