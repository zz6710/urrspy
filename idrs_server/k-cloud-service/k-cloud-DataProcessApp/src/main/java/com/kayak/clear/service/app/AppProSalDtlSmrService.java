...
//@Component
//@Scope("prototype")
//public class AppProSalDtlSmrService extends BaseTaskService<PubReq, PubResp> {
//
//    @Autowired
...
//
//    @StepNo(stepNo = 1)
//    protected void dealAppPordSale(PubReq request) throws Exception{
//        //直接使用insertselect 写法
//        String sysDate = DateUtil.getSysWordDay();
//        log.info("----------产品认申赎模型生成Start -----------");
//        String insertString= ExeQuery.queryExeId("INSERT04APP_PRD_SAL_DTL_SMR");
//        String deleteString=ExeQuery.queryExeId("DELETE04APP_PRD_SAL_DTL_SMR");
