...
@Component
@Scope("prototype")
public class AutoBatchGenerateSellData extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    @StepNo(stepNo = 1)
    protected void autoBatchGenerateSellData(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 销售文档公告自动生成 Start -----------");

        Map<String, Object> param = new HashMap<String, Object>();
        param.put("disclosureType","12");
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 销售文档公告自动生成 End-----------");
    }
