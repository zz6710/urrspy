...
//@Component
//@Scope("prototype")
//public class PrdNavInfService extends BaseTaskService<PubReq, PubResp> {
//
//    @Autowired
...
//
//    @StepNo(stepNo = 1)
//    protected void dealNetProdInfo(PubReq request) throws Exception{
//        //直接使用insertselect 写法
//        String sysDate = DateUtil.getSysWordDay();
//        log.info("----------产品净值信息模型生成Start -----------");
//        String insertString=ExeQuery.queryExeId("IT06NETPROD");
//        String deleteString=ExeQuery.queryExeId("DE06NETPROD");
