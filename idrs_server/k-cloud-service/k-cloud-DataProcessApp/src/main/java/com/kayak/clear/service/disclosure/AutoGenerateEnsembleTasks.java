...
@Component
@Scope("prototype")
public class AutoGenerateEnsembleTasks extends BaseTaskService<PubReq, PubResp> {
    ...
    @StepNo(stepNo = 1)
    protected void autoGenerateEnsembleTasks(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 整体公告任务自动生成 Start -----------");

        Map<String, Object> param = new HashMap<String, Object>();
        param.put("prodBaseDate",request.getTaskDate());
        Object body=ServerUtil.requestPost("PmsApp", "com.kayak.pms.disclosureControl.model.DisclosureProdTask", "autoAddDisclosureZTTasks", param);
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 整体公告任务自动生成 End-----------");
    }
