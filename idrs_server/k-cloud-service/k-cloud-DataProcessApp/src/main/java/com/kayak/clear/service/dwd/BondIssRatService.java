...
//@Component
//@Scope("prototype")
//public class BondIssRatService extends BaseTaskService<PubReq, PubResp> {
//
//    private static Logger log = LoggerFactory.getLogger(BondIssRatService.class);
//
//    @Autowired
...
//        log.info("---------- 债券主体评级数据:贴源层-->模型层:任务 Start -----------");
//        try {
//            Map<String, Object> params=new HashMap<>();
//            params.put("deal_date", DateUtil.getSysWordDay());
//            //执行语句先删后插
//            comnDao.update(ExeQuery.queryExeId("DELMDLBONDISSRATINGEQ01"), params);
//            comnDao.update(ExeQuery.queryExeId("ITMDLBONDISSRATINGEQ01"), params);
//            log.info("---------- 债券主体评级数据:贴源层-->模型层:任务 End -----------");
//        } catch (Exception e) {
//            throw new ModelDataHandleException("贴源层加工债券主体评级数据异常:" + e.getMessage());
//        }
//
//    }
//
