...
@Component
@Scope("prototype")
public class AutoGenerateProdDisRule extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    @StepNo(stepNo = 1)
    protected void autoGenerateProdDisRule(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 产品信披规则自动生成 Start -----------");


        Map<String, Object> param = new HashMap<String, Object>();
        param.put("prodBaseDate",request.getTaskDate());
        Object body=ServerUtil.requestPost("PmsApp", "com.kayak.pms.basePublish.model.DisclosureRule", "getProdDisRule", param);
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 产品信披规则自动生成 End-----------");
    }
