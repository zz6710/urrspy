...
@Component
@Scope("prototype")
public class ZyOneReportIndexValidationService extends BaseTaskService<PubReq, PubResp> {

    private static Logger log = LoggerFactory.getLogger(ZyOneReportIndexValidationService.class);
