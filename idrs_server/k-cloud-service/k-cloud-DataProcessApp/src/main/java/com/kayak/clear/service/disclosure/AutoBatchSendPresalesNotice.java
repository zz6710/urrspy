...
@Component
@Scope("prototype")
public class AutoBatchSendPresalesNotice extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    @StepNo(stepNo = 1)
    protected void autoBatchSendPresalesNotice(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 售前信息登记自动批量发布 Start -----------");
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 售前信息登记自动批量发布 End-----------");
    }
