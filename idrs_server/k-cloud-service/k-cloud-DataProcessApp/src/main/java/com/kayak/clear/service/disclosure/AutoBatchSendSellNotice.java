...
@Component
@Scope("prototype")
public class AutoBatchSendSellNotice extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    @StepNo(stepNo = 1)
    protected void autoBatchSendSellNotice(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 销售文档公告自动批量发布 Start -----------");
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 销售文档公告自动批量发布 End-----------");
    }
