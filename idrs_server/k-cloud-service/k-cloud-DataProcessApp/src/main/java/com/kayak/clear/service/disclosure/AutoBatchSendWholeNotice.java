...
@Component
@Scope("prototype")
public class AutoBatchSendWholeNotice extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    @StepNo(stepNo = 1)
    protected void autoBatchSendWholeNotice(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 整体报告自动批量发布 Start -----------");
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 整体报告自动批量发布 End-----------");
    }
