...
@Component
@Scope("prototype")
public class AutoGenerateExpireTasks extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    ...
    protected void autoGenerateExpireTasks(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 到期公告任务自动生成 Start -----------");

        Map<String, Object> param = new HashMap<String, Object>();
        param.put("prodBaseDate",request.getTaskDate());
        Object body=ServerUtil.requestPost("PmsApp", "com.kayak.pms.disclosureControl.model.DisclosureProdTask", "autoGenerateEndTask", param);
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 到期公告任务自动生成 End-----------");
    }
