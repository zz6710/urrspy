...
@Component
@Scope("prototype")
public class ZYReportIndexValidationService extends BaseTaskService<PubReq, PubResp> {

    private static Logger log = LoggerFactory.getLogger(ZYReportIndexValidationService.class);

    public static int DELAYED_DAYS = 3;
    ...
    protected void step1Process(PubReq request) throws Exception {
        ...
        log.info("---------- " + task_id + "自营报表指标校验:任务 执行结束 -----------");
    }
