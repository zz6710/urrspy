...
//@Component
//@Scope("prototype")
//public class AppProNavInfoService extends BaseTaskService<PubReq, PubResp> {
//
//    @Autowired
...
//        log.info("----------APP产品净值信息模型生成Start -----------");
//        String insertString= ExeQuery.queryExeId("INSERT02APP_PRD_NAV_INF");
//        String deleteString=ExeQuery.queryExeId("DELETE02APP_PRD_NAV_INF");
