...
@Component
@Scope("prototype")
public class AutoBatchSendBonusNotice extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    ...
    protected void autoBatchSendNetNotice(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 分红公告自动批量发布 Start -----------");
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 分红公告自动批量发布 End-----------");
    }
