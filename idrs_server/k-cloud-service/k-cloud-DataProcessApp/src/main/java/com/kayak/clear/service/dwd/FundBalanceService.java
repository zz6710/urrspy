...
//@Component
//@Scope("prototype")
//public class FundBalanceService extends BaseTaskService<PubReq, PubResp> {
//
//    private static Logger log = LoggerFactory.getLogger(FundBalanceService.class);
//
//    @Autowired
...
//        log.info("---------- 上市基金行情评级数据:贴源层-->模型层:任务 Start -----------");
//        try {
//            Map<String, Object> params=new HashMap<>();
//            params.put("deal_date", DateUtil.getSysWordDay());
//            //执行语句先删后插
//            comnDao.update(ExeQuery.queryExeId("DELMDLFUNDBALEQ01"), params);
//            comnDao.update(ExeQuery.queryExeId("ITMDLFUNDBALEQ01"), params);
//            log.info("---------- 上市基金行情评级数据:贴源层-->模型层:任务 End -----------");
//        } catch (Exception e) {
//            throw new ModelDataHandleException("贴源层加工上市基金行情评级数据异常:" + e.getMessage());
//        }
//
//    }
//
