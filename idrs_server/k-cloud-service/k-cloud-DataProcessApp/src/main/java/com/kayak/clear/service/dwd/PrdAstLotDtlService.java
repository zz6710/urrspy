...
//@Component
//@Scope("prototype")
//public class PrdAstLotDtlService extends BaseTaskService<PubReq, PubResp> {
//
//    @Autowired
...
//
//    @StepNo(stepNo = 1)
//    protected void dealAssetHodingDetail(PubReq request) throws Exception{
//        //直接使用insertselect 写法
//        String sysDate = DateUtil.getSysWordDay();
//        log.info("----------产品资产持仓明细模型生成Start -----------");
//        String insertString= ExeQuery.queryExeId("IT08ASSETDET");
//        String deleteString=ExeQuery.queryExeId("DE08ASSETDET");
