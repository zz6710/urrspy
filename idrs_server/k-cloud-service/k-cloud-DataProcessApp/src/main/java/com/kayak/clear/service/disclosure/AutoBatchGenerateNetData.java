...
@Component
@Scope("prototype")
public class AutoBatchGenerateNetData extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    @StepNo(stepNo = 1)
    protected void autoBatchGenerateNetData(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 净值报告自动生成 Start -----------");

        Map<String, Object> param = new HashMap<String, Object>();
        param.put("disclosureType","9");
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 净值报告自动生成 End-----------");
    }
