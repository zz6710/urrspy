...
@Component
@Scope("prototype")
public class AutoBatchGenerateRegularData extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    @StepNo(stepNo = 1)
    protected void autoBatchGenerateRegularData(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 定期报告自动生成 Start -----------");

        Map<String, Object> param = new HashMap<String, Object>();
        param.put("disclosureType","5");
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 定期报告自动生成 End-----------");
    }
