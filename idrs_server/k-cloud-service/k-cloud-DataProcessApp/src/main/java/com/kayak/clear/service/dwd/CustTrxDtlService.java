...
//@Component
//@Scope("prototype")
//public class CustTrxDtlService extends BaseTaskService<PubReq, PubResp> {
//
//    @Autowired
...
//
//    @StepNo(stepNo = 1)
//    protected void dealInvestorDetail(PubReq request) throws Exception{
//        //直接使用insertselect 写法
//        String sysDate = DateUtil.getSysWordDay();
//        log.info("----------客户交易明细模型生成Start -----------");
//        String insertString= ExeQuery.queryExeId("IT04INVDET");
//        String deleteString=ExeQuery.queryExeId("DE04INVDET");
