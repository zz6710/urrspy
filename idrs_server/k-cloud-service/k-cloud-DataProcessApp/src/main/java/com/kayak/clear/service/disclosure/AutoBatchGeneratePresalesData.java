...
@Component
@Scope("prototype")
public class AutoBatchGeneratePresalesData extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    @StepNo(stepNo = 1)
    protected void autoBatchGeneratePresalesData(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 售前信息登记公告自动生成 Start -----------");

        Map<String, Object> param = new HashMap<String, Object>();
        param.put("disclosureType","1");
        Object body=ServerUtil.requestPost("PmsApp", "com.kayak.pms.disclosureControl.model.DisclosureProdTask", "autoBatchGenerateData", param);
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 售前信息登记公告自动生成 End-----------");
    }
