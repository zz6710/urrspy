...
@Component
@Scope("prototype")
public class AutoBatchSendExpireNotice extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    @StepNo(stepNo = 1)
    protected void autoBatchSendExpireNotice(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 到期公告自动批量发布 Start -----------");
        ...
        log.info("---------- 任务: " + request.getTaskId() +"  到期公告自动批量发布 End-----------");
    }
