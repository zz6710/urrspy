...
//@Component
//@Scope("prototype")
//public class BondCsiValueService extends BaseTaskService<PubReq, PubResp> {
//
//    private static Logger log = LoggerFactory.getLogger(BondCsiValueService.class);
//
//    @Autowired
...
//        log.info("---------- 债券中证估值数据:贴源层-->模型层:任务 Start -----------");
//        try {
//            Map<String, Object> params=new HashMap<>();
//            params.put("deal_date", DateUtil.getSysWordDay());
//            //执行语句先删后插
//            comnDao.update(ExeQuery.queryExeId("DELMDLCSIVALEQ01"), params);
//            comnDao.update(ExeQuery.queryExeId("ITMDLCSIVALEQ01"), params);
//            log.info("---------- 债券中证估值数据:贴源层-->模型层:任务 End -----------");
//        } catch (Exception e) {
//            throw new ModelDataHandleException("贴源层加工债券中证估值数据异常:" + e.getMessage());
//        }
//
//    }
//
