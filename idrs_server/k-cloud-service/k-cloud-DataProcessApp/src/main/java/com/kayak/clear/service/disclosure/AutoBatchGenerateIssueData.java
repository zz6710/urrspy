...
@Component
@Scope("prototype")
public class AutoBatchGenerateIssueData extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    @StepNo(stepNo = 1)
    protected void autoBatchGenerateIssueData(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 发行成立公告自动生成 Start -----------");

        Map<String, Object> param = new HashMap<String, Object>();
        param.put("disclosureType","2");
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 发行成立公告自动生成 End-----------");
    }
