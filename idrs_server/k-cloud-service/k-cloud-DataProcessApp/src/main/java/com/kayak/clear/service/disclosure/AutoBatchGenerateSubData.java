...
@Component
@Scope("prototype")
public class AutoBatchGenerateSubData extends BaseTaskService<PubReq, PubResp> {
    ...
    */
    @StepNo(stepNo = 1)
    protected void autoBatchGenerateSubData(PubReq request) throws Exception{
        log.info("---------- 任务: " + request.getTaskId() +" 申购赎回公告自动生成 Start -----------");
        ...
        log.info("---------- 任务: " + request.getTaskId() +" 申购赎回公告自动生成 End-----------");
    }
