...
@Data
@GraphQLModel(fetcher = "gridRltPtyOsdService", table = "app_grid_rlt_pty_osd_base")
public class GridRltPtyOsd {
    ...
    @GraphQLField(kkhtml = "KFieldText", label = "交易标的", sql = "deal_subject  = $S{dealSubject}" ,field = "deal_subject")
    private String dealSubject;
    @GraphQLField(kkhtml = "KFieldText", label = "交易方向", sql = "deal_direction = $S{dealDirection}" ,field = "deal_direction")
