 ...
 * @description: 产品份额
 * @author:  axin
 * @create: 2021-03-16 16:19:39
 * @memo 备注信息
 */

@Data
@GraphQLModel(fetcher="t8ProdSalesInfoService",table="ods_amng_prod_impinfo")
public class T8ProdSalesInfo {
	...
	@GraphQLField(kkhtml = "KFieldText", label = "附件描述", sql = "remark = $S{remark}" ,field = "remark")
