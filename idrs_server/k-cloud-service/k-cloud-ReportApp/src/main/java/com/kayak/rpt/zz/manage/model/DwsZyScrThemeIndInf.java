...
@GraphQLModel(fetcher = "dwsZyScrThemeIndInfService",table = "dws_zy_scr_theme_ind_inf")
@Data
public class DwsZyScrThemeIndInf {
   ...
   @GraphQLField(kkhtml = "KFieldText", label = "已计提减值准备余额", sql = "accrue_amt = $S{accrueAmt}" ,field = "accrue_amt")
   private String accrueAmt;
