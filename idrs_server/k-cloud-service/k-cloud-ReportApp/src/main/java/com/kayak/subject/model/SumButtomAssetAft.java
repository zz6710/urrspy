...
@GraphQLModel(fetcher = "sumButtomAssetServiceAft",table = "dwd_sum_buttom_asset")
@Data
public class SumButtomAssetAft {
   ...
   @GraphQLField(kkhtml = "KFieldText", label = "估值日期", sql = "input_date = $S{inputDate}" ,field = "input_date")
