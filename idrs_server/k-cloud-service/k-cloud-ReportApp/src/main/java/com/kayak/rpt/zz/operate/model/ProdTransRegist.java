...
@Data
@GraphQLModel(fetcher = "prodTransRegistService",table = "app_prod_trans_regist_remark")
public class ProdTransRegist {
   ...
   @GraphQLField(key = true ,kkhtml = "KFieldText", label = "行内交易编码", sql = "trans_code like '%$U{transCode}%'" ,field = "trans_code")
   private String transCode;
   @GraphQLField(key = true ,kkhtml = "KFieldText", label = "资产负债编码", sql = "asset_code like '%$U{assetCode}%'" ,field = "asset_code")
   ...
   @GraphQLField(key = true ,kkhtml = "KFieldText", label = "资金流动类型", sql = "cash_type = $S{cashType}" ,field = "cash_type")
   ...
   private String opType;
    ...
    @GraphQLField(kkhtml = "KFieldText", label = "是否覆盖数据", sql = "is_cover = $S{isCover}" ,field = "isCover")
