...
@GraphQLModel(fetcher = "prodConsignmentSalesStopService",table = "app_prod_consignment_sales_stop")
@Data
public class ProdConsignmentSalesStop {

   @GraphQLField(key = true ,kkhtml = "KFieldText", label = "", sql = "id = $S{id}" ,field = "id")
   private String id;
   @GraphQLField(kkhtml = "KFieldText", label = "代销产品到期日期", sql = "end_date = $S{endDate}" ,field = "end_date")
