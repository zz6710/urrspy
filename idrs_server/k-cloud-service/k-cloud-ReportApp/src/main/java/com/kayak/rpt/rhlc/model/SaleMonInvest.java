...
@GraphQLModel(fetcher = "saleMonInvestService",table = "app_prod_sale_investor")
@Data
public class SaleMonInvest {
   ...
   @GraphQLField(kkhtml = "KFieldText", label = "*投资者类型", sql = "investor_type = $S{investorType}" ,field = "investor_type")
