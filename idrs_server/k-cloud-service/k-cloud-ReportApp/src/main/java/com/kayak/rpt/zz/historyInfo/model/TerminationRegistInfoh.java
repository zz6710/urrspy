...
@Data
@GraphQLModel(fetcher = "terminationRegistInfohService",table = "app_termination_regist_info_h")
public class TerminationRegistInfoh {
   ...
   private Double annualReturnProd;
    ...
    @GraphQLField(label = "开始时间")
    private String actProdTerStartDate;

    @GraphQLField(label = "结束时间")
    private String actProdTerEndDate;
    ...
    public String getActProdTerStartDate() {
        return actProdTerStartDate;
    }
}