...
public class RHZYDownloadController extends BaseController {
    ...
    public void downloadFile(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (StringUtils.isNotEmpty((String) params.get("reportDate"))) {
            String reportDate = params.get("reportDate") + "01";
        ...
        //金融机构法人标准代码_
        String orgno = CacheUtil.getSystemParam("10018");
        String path;
