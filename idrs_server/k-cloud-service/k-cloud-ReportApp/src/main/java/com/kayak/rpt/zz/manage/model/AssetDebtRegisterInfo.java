...
@Data
@GraphQLModel(fetcher = "assetDebtRegisterInfoService",table = "app_asset_debt_register_info")
public class AssetDebtRegisterInfo {
   ...
   @GraphQLField(kkhtml = "KFieldText", label = "法定到期日", sql = "ee_project_dt = $S{eeProjectDt}" ,field = "ee_project_dt")
   private String eeProjectDt;
   @GraphQLField(kkhtml = "KFieldText", label = "项目期限", sql = "ee_statutory_maturity_date = $S{eeStatutoryMaturityDate}" ,field = "ee_statutory_maturity_date")
   ...
   @GraphQLField(kkhtml = "KFieldText", label = "项目收益率(利率)%", sql = "ee_project_annaul_return = $S{eeProjectAnnaulReturn}" ,field = "ee_project_annaul_return")
   ...
   @GraphQLField(kkhtml = "KFieldText", label = "利差(BP)", sql = "ee_yield_spread_bp = $S{eeYieldSpreadBp}" ,field = "ee_yield_spread_bp")
   ...
   @GraphQLField(kkhtml = "KFieldText", label = "融资人类型（按规模划分）", sql = "ee_debtor_type_scale = $S{eeDebtorTypeScale}" ,field = "ee_debtor_type_scale")
   private String eeDebtorTypeScale;
   @GraphQLField(kkhtml = "KFieldText", label = "融资人类型（按技术领域划分）", sql = "ee_debtor_type_tech = $S{eeDebtorTypeTech}" ,field = "ee_debtor_type_tech")
   private String eeDebtorTypeTech;
   @GraphQLField(kkhtml = "KFieldText", label = "融资人类型（按经济类型划分）", sql = "ee_debtor_type_economic = $S{eeDebtorTypeEconomic}" ,field = "ee_debtor_type_economic")
   ...
   @GraphQLField(kkhtml = "KFieldText", label = "抵质押物价值（元）", sql = "ee_pledge_value = $S{eePledgeValue}" ,field = "ee_pledge_value")
   ...
   @GraphQLField(kkhtml = "KFieldText", label = "是否为收/受益权", sql = "ff_ownership = $S{ffOwnership}" ,field = "ff_ownership")
   ...
   @GraphQLField(kkhtml = "KFieldText", label = "项目期限", sql = "ss_project_dtss_project_dt = $S{ssProjectDt}" ,field = "ss_project_dt")
   private String ssProjectDt;
   ...
   private String  AssetDebtRegisterType;
...
//   @GraphQLField(kkhtml = "KFieldText", sql = "register_date >= $S{startDate}" ,field = "startDate")
   @GraphQLField(kkhtml = "KFieldText")
   private String startDate;
//   @GraphQLField(kkhtml = "KFieldText", sql = "register_date <= $S{endDate}" ,field = "endDate")
   @GraphQLField(kkhtml = "KFieldText")
   ...
   @GraphQLField(kkhtml = "KFieldText", sql = "asset_debt_register_type <= $S{assetDebtRegisterType}" ,field = "asset_debt_register_type")
   private String assetDebtRegisterType;

   @GraphQLField(kkhtml = "KFieldText", sql = "data_change_type = $S{dataChangeType}" ,field = "data_change_type")
