...
@Data
@GraphQLModel(fetcher = "custTransInfohService",table = "app_cust_trans_info_h")
public class CustTransInfoh {
   ...
   @GraphQLField(kkhtml = "KFieldText", label = "部分登记日期", sql = "part_register_date = $S{partRegisterDate}" ,field = "part_register_date")
   private String partRegisterDate;
    ...
    @GraphQLField(kkhtml = "KFieldText", label = "导入日期截止时间")
