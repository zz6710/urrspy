...
@Data
@GraphQLModel(fetcher = "prodIssuanceRegistService",table = "app_prod_issuance_regist_remark")
public class ProdIssuanceRegist {
   ...
   private String opType;
    ...
    @GraphQLField(kkhtml = "KFieldText", label = "分级比列", sql = "clsf_sto = $S{clsfSto}" ,field = "clsf_sto")
