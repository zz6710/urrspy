...
@Data
@GraphQLModel(fetcher = "prodStateRegistInfohService",table = "app_prod_state_regist_info_h")
public class ProdStateRegistInfoh {
   ...
   @GraphQLField(kkhtml = "KFieldText", label = "理财产品总资产金额", sql = "tot_assets = $S{totAssets}" ,field = "tot_assets")
