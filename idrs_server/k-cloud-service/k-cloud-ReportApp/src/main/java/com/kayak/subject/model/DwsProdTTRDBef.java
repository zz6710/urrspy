...
@GraphQLModel(fetcher = "dwsProdTTRDBefService",table = "dws_prod_ttrd_bef_g06a2")
@Data
public class DwsProdTTRDBef {
   ...
   @ExcelIgnore
   @GraphQLField(kkhtml = "KFieldText", label = "参数值", sql = "paraid = $S{paraid}" ,field = "paraid")
   private String paraid;
   @ExcelIgnore
   @GraphQLField(kkhtml = "KFieldText", label = "菜单id", sql = "menuId = $S{menuId}" ,field = "menuId")
   private String menuId;
   @ExcelIgnore
   @GraphQLField(kkhtml = "KFieldText", label = "按钮名称", sql = "buttonName = $S{buttonName}" ,field = "buttonName")
