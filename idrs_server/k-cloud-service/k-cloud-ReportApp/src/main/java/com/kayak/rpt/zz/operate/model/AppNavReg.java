...
@Data
@GraphQLModel(fetcher = "appNavRegService",table = "app_nav_info_reg_remark")
public class AppNavReg {
    ...
    @GraphQLField(kkhtml = "KFieldText", label = "数据操作类型", sql = "op_type = $S{opType}" ,field = "op_type")
