...
@Data
@GraphQLModel(fetcher = "assetDebtRegisterInfoErrService",table = "app_asset_debt_register_info_erdesc")
public class AssetDebtRegisterInfoErr {
   ...
   @GraphQLField(kkhtml = "KFieldText", label = "导入日期", sql = "DATE(imp_date) = DATE($S{impDate})" ,field = "imp_date")
   private String impDate;
   @GraphQLField(kkhtml = "KFieldText", label = "投资者登记日期")
   ...
   private String mmMaxExpectedReturn;
   ...
   private String mmMinExpectedReturn;
   ...
   private String reportDate;
    ...
    public void setEeEnhanceInstituteName(String eeEnhanceInstituteName) {
  	...
  	public String getEeTotalFeeRate() {
        return eeTotalFeeRate;
    }

    public void setEeTotalFeeRate(String eeTotalFeeRate) {
    ...
    public void setMmExpectedReturn(String mmExpectedReturn) {
  	...
  	public String getMmMaxExpectedReturn() {
        return mmMaxExpectedReturn;
    }

    public void setMmMaxExpectedReturn(String mmMaxExpectedReturn) {
        this.mmMaxExpectedReturn = mmMaxExpectedReturn;
    }
  	public String getMmMinExpectedReturn() {
        return mmMinExpectedReturn;
    }

    public void setMmMinExpectedReturn(String mmMinExpectedReturn) {
    ...
    public void setMmManagerType(String mmManagerType) {
  	...
  	public String getMmManagerFeeRate() {
        return mmManagerFeeRate;
    }

    public void setMmManagerFeeRate(String mmManagerFeeRate) {
        this.mmManagerFeeRate = mmManagerFeeRate;
    }
  	public String getMmCustodianFeeRate() {
        return mmCustodianFeeRate;
    }

    public void setMmCustodianFeeRate(String mmCustodianFeeRate) {
        this.mmCustodianFeeRate = mmCustodianFeeRate;
    }
  	public String getMmTransCostRate() {
        return mmTransCostRate;
    }

    public void setMmTransCostRate(String mmTransCostRate) {
        this.mmTransCostRate = mmTransCostRate;
    }
  	public String getMmInterFeeRate() {
        return mmInterFeeRate;
    }

    public void setMmInterFeeRate(String mmInterFeeRate) {
    ...
    public void setSsExpectedReturn(String ssExpectedReturn) {
  	...
  	public String getSsAnnualReturn() {
        return ssAnnualReturn;
    }

    public void setSsAnnualReturn(String ssAnnualReturn) {
