...
@Data
@GraphQLModel(fetcher = "prodRegistFilingService",table = "app_prod_regist_filing_remark")
public class ProdRegistFiling {
   ...
   @GraphQLField(kkhtml = "KFieldText", label = "产品品牌", sql = "prod_brand like '%$U{prodBrand}%'" ,field = "prod_brand")
   ...
   @GraphQLField(kkhtml = "KFieldText", label = "尽职调查", sql = "due_diligencr_doc = $S{dueDiligencrDoc}" ,field = "due_diligencr_doc")
   private String dueDiligencrDoc;
   @GraphQLField(kkhtml = "KFieldText", label = "法律文件", sql = "legal_doc_sifned = $S{legalDocSifned}" ,field = "legal_doc_sifned")
   ...
   private String opType;
    ...
    @GraphQLField(kkhtml = "KFieldText", label = "产品特殊属性", sql = "PROD_ESP_PRPT = $S{prodEspPrpt}" ,field = "PROD_ESP_PRPT")
