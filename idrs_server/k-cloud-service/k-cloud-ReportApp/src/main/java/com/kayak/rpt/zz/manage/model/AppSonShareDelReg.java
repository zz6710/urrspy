...
@GraphQLModel(fetcher = "appSonShareDelRegService",table = "app_son_share_del_reg")
@Data
public class AppSonShareDelReg {
   ...
   @GraphQLField(kkhtml = "KFieldText", label = "子份额登记模式", sql = "son_share_task_type = $S{sonShareTaskType}" ,field = "son_share_task_type")
   private String sonShareTaskType;
   @GraphQLField(kkhtml = "KFieldText", label = "业务日期", sql = "task_date = $S{taskDate}" ,field = "task_date")
   private String taskDate;
   @GraphQLField(kkhtml = "KFieldText", label = "删除原因", sql = "details = $S{details}" ,field = "details")
