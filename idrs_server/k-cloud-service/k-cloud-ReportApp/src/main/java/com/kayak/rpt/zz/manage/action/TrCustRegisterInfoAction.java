...
@Slf4j
@RestController
public class TrCustRegisterInfoAction extends BaseController {

    @Autowired
    private TrCustRegisterInfoService trCustRegisterInfoService;
    ...
    @RequestMapping(value = "/chinaBondSubmit/TrCustRegisterInfo/comn-upload.json",produces = { "application/json;charset=UTF-8"})
    public String upload(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            result = trCustRegisterInfoService.batchImport(fileName, file);
    ...
    @RequestMapping(value = "/chinaBondSubmit/TrCustRegisterInfo/comn-download.json",produces = { "application/json;charset=UTF-8"})
    public void exportFile(String fileName, HttpServletResponse response) {
        // fileName = "ImportModel.xlsx";
        fileName = "TrCustRegisterInfo.xlsx";
