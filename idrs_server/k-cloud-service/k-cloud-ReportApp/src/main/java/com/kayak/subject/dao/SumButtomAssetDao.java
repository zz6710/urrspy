...
@Repository
public class SumButtomAssetDao extends ComnDao {

	public SqlResult<SumButtomAsset> findSumButtomAssets(SqlParam<SumButtomAsset> params) throws Exception {
		String sql = "SELECT id,comcode,bottom_code,asset_type,amount,cost,currency,input_date,item_id,item_name,import_date,i_code as icode,i_name_c1 as inamec1," +
				"            i_name_c2 as inamec2,a_type as atype,m_type as mtype,asset_code,org_level,net_value,zz_report_type,g06_type,rat_level,is_ppp_part,is_mkt_bts_rlt," +
				"            is_gov_fnc_part,is_fnc_stk,is_fnc_bnd,is_fnc_scd_bnd,is_fnc_tsf_bnd,is_oth_bnk_tls,is_gov_spc_bnd,exchange_rate,inv_val_rate,pen_inv_f," +
				"            format(inv_val_rate_pen,10) as inv_val_rate_pen,per_pen_inv_f,format(inv_val_rate_per_pen,10) as inv_val_rate_per_pen,non_grt_rate,non_grt_amt," +
				"            trade_place,is_public,manage_mode,mark,data_insr_dt,deal_date,is_real_setate,is_csh_mng,format(inv_val_rate_csh,10) as inv_val_rate_csh ,hk_inv,qdii_inv" +
				"       FROM dwd_sum_buttom_asset_ori " +
				"      where (ASSET_TYPE <> '02' or ASSET_TYPE is null)";
	...
	public UpdateResult addSumButtomAsset(SqlParam<SumButtomAsset> params) throws Exception {
	...
	public UpdateResult updateSumButtomAsset(SqlParam<SumButtomAsset> params) throws Exception {
	...
	public UpdateResult deleteSumButtomAsset(SqlParam<SumButtomAsset> params) throws Exception {
