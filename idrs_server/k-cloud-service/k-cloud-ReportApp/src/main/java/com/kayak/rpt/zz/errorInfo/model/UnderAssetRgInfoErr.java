...
@Data
@GraphQLModel(fetcher = "underAssetRgInfoErrService",table = "app_under_asset_regist_info_erdesc")
public class UnderAssetRgInfoErr {
    @GraphQLField(label = "id")
    private String id;
   @GraphQLField(kkhtml = "KFieldText", label = "发行机构代码错误", sql = "bank_code = $S{bankCode}" ,field = "bank_code")
   private String bankCode;
   @GraphQLField(kkhtml = "KFieldText", label = "对应资管及委外资产行内资产/负债编码错误", sql = "asset_manager_code = $S{assetManagerCode}" ,field = "asset_manager_code")
   ...
   @GraphQLField(kkhtml = "KFieldText", label = "资管及委外资产当前总数量错误", sql = "asset_sum_number = $S{assetSumNumber}" ,field = "asset_sum_number")
   ...
   @GraphQLField(kkhtml = "KFieldText", label = "底层资产行内资产/负债编码错误", sql = "under_asset_code = $S{underAssetCode}" ,field = "under_asset_code")
   private String underAssetCode;
   @GraphQLField(kkhtml = "KFieldText", label = "底层资产持仓数量错误", sql = "under_asset_sum = $S{underAssetSum}" ,field = "under_asset_sum")
   private String underAssetSum;
   @GraphQLField(kkhtml = "KFieldText", label = "底层资产折算人民币市值", sql = "under_convert_sum_amt = $S{underConvertSumAmt}" ,field = "under_convert_sum_amt_")
   private String underConvertSumAmt;
   @GraphQLField(kkhtml = "KFieldText", label = "持仓日期错误", sql = "report_date = $S{reportDate}" ,field = "report_date")
