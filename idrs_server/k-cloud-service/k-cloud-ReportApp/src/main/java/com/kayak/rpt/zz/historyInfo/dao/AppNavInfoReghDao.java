...
@Repository
public class AppNavInfoReghDao extends ComnDao {

	public SqlResult<AppNavInfoRegh> findAppNavInfoReghs(SqlParam<AppNavInfoRegh> params) throws Exception {
