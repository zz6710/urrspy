...
import com.kayak.rpt.zz.manage.service.TrCustVolRegisterInfoService;
...
@Slf4j
@RestController
public class TrCustVolRegisterInfoAction extends BaseController {

    @Autowired
    private TrCustVolRegisterInfoService trCustVolRegisterInfoService;
    ...
    @RequestMapping(value = "/chinaBondSubmit/TrCustVolRegisterInfo/comn-upload.json",produces = { "application/json;charset=UTF-8"})
    public String upload(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            result = trCustVolRegisterInfoService.batchImport(fileName, file);
    ...
    @RequestMapping(value = "/chinaBondSubmit/TrCustVolRegisterInfo/comn-download.json",produces = { "application/json;charset=UTF-8"})
    public void exportFile(String fileName, HttpServletResponse response) {
        // fileName = "ImportModel.xlsx";
        fileName = "TrCustVolRegisterInfo.xlsx";
