...
@Data
@GraphQLModel(fetcher = "userService", table = "sys_user")
public class User {
	...
	@GraphQLField(kkhtml = "KFieldSelect", kkhtmlExt = "{\"data-diffcondition\":\"orgno,parentorgno\",\"data-graphql\":\"{queryRole(action:\\\"find\\\",roleids:\\\"0\\\") {rows{roleid, rolename, parentroleid, descript},results}}\",\"data-display-field\":\"rolename\",\"data-value-field\":\"roleid\"}", label = "角色", field = "roleId")
	private String roleId;

	@GraphQLField
	private String oldPwd;

	@GraphQLField(field = "eiam_pwd")
	private String eiamPwd;
}