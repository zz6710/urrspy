...
public class SqlConfig {
    ...
    public SqlConfig(String action, String desc, String auth, String makeSearchSql, boolean log, int datasource,String interceptor,String repeat, String datasourceName) throws Exception {
        this.action = action;
        this.desc = desc;
        this.auth = auth;
