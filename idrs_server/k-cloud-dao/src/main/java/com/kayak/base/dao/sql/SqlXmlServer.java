...
public class SqlXmlServer {
    ...
    public static String loadSqlInfoFile(Resource resource) throws Exception {
        ...
        while (configs.hasNext()) {
            ...
            String datasourceName = XmlUtil.getAttributeString(sqlinfoEl, "datasourceName");
            ...
            SqlConfig conf = new SqlConfig(action, desc, action, makeSearchSql, islog, Tools.str2Int(datasource), interceptor, repeat, datasourceName);
                ...
                if (checkIt != null) {
                    ...
                    while (checkIt.hasNext()) {
                        ...
                        int checkDatasource = XmlUtil.getAttributeInt(checkEl,
                                "datasource", 0);
                        String checkDatasourceName = XmlUtil.getAttributeString(checkEl,
                                "datasourceName", "");
                        ...
                        SqlCheck chk = new SqlCheck(checkname, checksql,
                                ...
                                comparesign, errtext, exitall, checkDatasource, checkDatasourceName);
                        if (sqlEls != null) {
     ...
     * @return
     */
    public static Sql getSql(Class<?> modelClass, String action) {
        return getSql(modelClass.getSimpleName(), action);
    }
     ...
     * @return
     */
    public static Sql getSql(String modelName, String action) {
        SqlConfig sqlConfig = sqlCache.get(modelName).get(action);
        Sql sql = new Sql();
