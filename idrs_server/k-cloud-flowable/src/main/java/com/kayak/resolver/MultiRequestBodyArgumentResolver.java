...
public class MultiRequestBodyArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    /**
     *  解决使用 @MultiRequestBody时，@Validated不生效的问题
     * @param parameter
     * @param mavContainer
     * @param webRequest
     * @param binderFactory
     ...
     */
    public Object readWithMessage( NativeWebRequest webRequest,MethodParameter parameter) throws Exception {
