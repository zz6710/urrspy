...
import com.kayak.config.listener.ConfigListener;
...
public class ConfigUitl {
	...
	public static String getNacosConfigValue(String serverAddr, String dataId, String group, String key)
			throws Exception {
		return getNacosConfigValue(serverAddr, SpringUtil.getApplicationContext().getEnvironment()
	...
	public static String getNacosConfigValue(String dataId, String group, String key) throws Exception {
		Environment evn = SpringUtil.getApplicationContext().getEnvironment();
	...
	public static String getConfigValue(String key) throws Exception {
		return SpringUtil.getApplicationContext().getEnvironment().getProperty(key);
	}
	...
	public static void addNacosConfigListener(String dataId, ConfigListener configListener) throws Exception {
		...
		configService.addListener(dataId, "DEFAULT_GROUP", new Listener() {
			...
			public void receiveConfigInfo(String configInfo) {
				configListener.receiveConfig(configInfo);
			}
		});
