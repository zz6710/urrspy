<template>
  <div class="full-page" :class="{ 'nav-open': $sidebar.showSidebar }">
    <md-toolbar md-elevation="0" class="md-transparent md-toolbar-absolute">
      <md-icon md-src="/static/svg/login/kkws_logo.svg" style="width:220px;height:36px;margin:0;margin-top: 10px;"></md-icon>
      <!--     <md-icon md-src="/static/svg/login/kkws_logo.svg" style="width:220px;height:36px;margin:0;margin-top: 10px;"></md-icon>-->
    ...
    <div class="wrapper wrapper-full-page" @click="toggleSidebarPage">
      <div class="page-header header-filter" :class="setPageClass" filter-color="black" :style="setBgImage">
        ...
        <footer class="footer">
          <div class="container md-offset">
            <div>{{loginConfig.companyName}}</div>
            <div class="copyright text-center">
              https://www.kayak.com/
            </div>
            <!--            <div class="copyright text-center">
                          https://www.kayak.com.cn/
                        </div>-->
          </div>
        </footer>
      </div>
...
export default {
  ...
  computed: {
    setBgImage() {
      let images = {
        LoginBox: "/static/images/login.jpg"
      };
      return {
