  ...
  <div class="oa-page">
    <div class="oa-container">
      <el-form ref="form" :model="formObj">
        <el-table border stripe size="small" :data="formObj.tableData">
          ...
          <el-table-column prop="subProjectName" label="子项目名称" width="160">
            <template slot-scope="scope">
              <div class="flex">
                <div class="required">
                  <div
                ...
                <el-button
                  class="select-projectName-button"
                  type="primary"
                  size="mini"
                  @click="dialogSelect(scope.$index, 'subProjectName')"
                  >选择</el-button
                >
              </div>
            </template>
          </el-table-column>
          <el-table-column prop="jobType" label="工作类型" width="140">
            <template slot-scope="scope">
              <div class="flex">
                <div class="required">
                  <div
          ...
          <el-table-column prop="jobContent" label="工作内容" width="200">
            <template slot-scope="scope">
              <div class="flex">
                <div class="required">
                  <div
          ...
          <el-table-column prop="workHours" label="工时(小时)" width="80">
            <template slot-scope="scope">
              <div class="flex">
                <div class="required">
                  <div
          ...
          <el-table-column prop="travelStatus" label="出差状态" width="120">
            <template slot-scope="scope">
              <div class="flex">
                <div class="required">
                  <div
          ...
          <el-table-column prop="roomName" label="宿舍名称" width="160">
            <template slot-scope="scope">
              <div class="flex">
                <div class="required">
                  <div
                ...
                <el-button
                  ...
                  type="primary"
                  size="mini"
                  @click="dialogSelect(scope.$index, 'roomName')"
                  >选择</el-button
                >
              </div>
            </template>
