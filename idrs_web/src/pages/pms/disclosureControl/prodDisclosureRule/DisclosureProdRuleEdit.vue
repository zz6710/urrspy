<template>
  <div>
    <k-form ref="editDisclosureProdRuleForm" :data-col="2" data-label-width="130px" data-input-width="180px" :isFormBodyScreen="true" >
      ...
      <k-form-item label="产品名称" data-col="2">
        <k-field-select v-model="formData.prodCode" data-action="T8ProdInfo.getProdInfosAndCode" data-value-field="prodCode"
                        data-display-field="prodCode,prodName"  :data-allowblank="false" :data-disabled="true" :data-max-length="100"/>
      </k-form-item>
      <k-form-item label="产品全称" :data-col="2">
        <k-field-text v-model="formData.prodFullName" :data-allowblank="false" :data-max-length="100"/>
      </k-form-item>
    ...
    <k-form-footer data-align="center">
      <k-btn class="btn-custom-primary" data-functype="SUBMIT"  data-action="DisclosureProdRule.updateDisclosureProdRule"
             data-from="editDisclosureProdRuleForm"
