<template>
  <div class="myDataRecord tab-page">
    <div class="myDataRecord_block01">
      <div class="myDataRecord_block01_line1" >
    ...
    <!-- <div class="myDataRecord_block02"> -->
      <!-- <div> -->
