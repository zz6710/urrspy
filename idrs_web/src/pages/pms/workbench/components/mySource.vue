<template>
  <div class="mySource tab-page">
    <div class="mySource_block01">
      <div class="mySource_block01_line1">
        <div>确认状态:</div>
...
<!--          <k-field-date v-model="searchParam.dealDate" data-value-format="yyyyMMdd"  :data-default-value="currentDate" @data-on-change="changeTab()" ></k-field-date>-->
    ...
    <!-- <div class="mySource_block02"> -->
      <k-grid ref="sourceDataChgInfo2" data-action="SourceDataChgInfoModel.findSourceDataChgInfoModelForOne" @data-row-select="selectRow" :data-autoload="false" data-operate-width="200px">
...
export default {
  ...
  methods: {
    loadGriding(val){
      ...
      this.$refs.sourceDataChgInfo2.load(params);
    },
