<template>
  <div class="py-page">
    <div>
      <k-form-search-customize data-model-name="SourceDataChgInfoModel" v-model="queryParam" data-target="sourceDataChgInfoGrid">
    ...
    <div class="py-page-container">
      <k-grid ref="sourceDataChgInfoGrid" @data-row-select="selectRow" data-fixed="right" data-operate-width="200px"
              data-action="SourceDataChgInfoModel.findSourceDataChgInfoModelForOne" :data-autoload="true" :data-display="false" border="true">
        ...
        <k-grid-column data-header="清算数据组" data-name="taskGroup" data-hidden="true"></k-grid-column>
  ...
  export default {
    ...
    created() {
      if(this.$route.query!=null && this.$route.query !== '' && this.$route.query!==undefined){
        ...
        this.$nextTick(() => {
          this.$refs.sourceDataChgInfoGrid.load(this.queryParam);
        });
      }
    },
    methods: {
