<template>
  <div class="formPanel" ref="formPanel" style="margin-left: 15%;">
    <div class="form-item prod-panel" >
      ...
      <DisplayPrintTempUpload ref="addProdForm" v-model="formData" :formData="formData"/>
    </div>
...
<script>
  import DisplayPrintTempUpload         from "../../../M81/prodDisplay/prodDocument/DisplayPrintTempUpload.vue"
  export default {
    name: "PrintTempUploadFlow",
    components: {
      DisplayPrintTempUpload
    },
    props:{
      taskInfo: {},
    },
