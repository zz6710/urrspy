<template>
  <div class="formPanel" ref="formPanel" style="margin-left: 15%;">
    <div class="form-item prod-panel" >
      ...
      <DisplayDividendPlan ref="addDelyForm" v-model="formData" :formData="formData"/>
    </div>
  </div>
</template>

<script>
  import DisplayDividendPlan         from "../../M81/prodDisplay/dividendPlan/DisplayDividendPlan.vue"
  export default {
    name: "DividendPlanFlow",
    components: {
      DisplayDividendPlan
    },
    props:{
