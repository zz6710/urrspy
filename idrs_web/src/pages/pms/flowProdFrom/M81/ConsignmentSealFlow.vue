<template>
  <div class="formPanel" ref="formPanel" style="margin-left: 15%;">
    <div class="form-item prod-panel" >
      ...
      <DisplayConsignmentSeal ref="applicationForm" v-model="application" :application="application"/>
    </div>
  </div>
</template>

<script>
  import DisplayConsignmentSeal         from "../../M81/prodDisplay/documentSeal/DisplayConsignmentSeal"
  export default {
    name: "ConsignmentSealFlow",
    components: {
      DisplayConsignmentSeal
    },
    props:{
      taskInfo: {},
    },
