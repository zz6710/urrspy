...
<!--    </div>-->
    ...
    <div class="form-item prod-panel" id="prodWorkDay" >
      ...
      <div style="margin-top: 40px">
        <DisplayPrintTempVersion ref="addProdForm" v-model="formData" :formData="formData"/>
      </div>
    </div>
  </div>
</template>
...
<script>
  import DisplayPrintTempVersion         from "../../M81/prodDisplay/PrintTempVersion/DisplayPrintTempVersion.vue"
  export default {
    name: "PrintTempVersionServiceFlow",
    components: {
      DisplayPrintTempVersion
    },
    props:{
      taskInfo: {},
    },
