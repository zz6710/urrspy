<template>
  <div class="formPanel" ref="formPanel" style="margin-left: 15%;">
    <div class="form-item prod-panel" >
      ...
      <DisplayUpdCreative ref="applicationForm" v-model="formData" :formData="formData"/>
    </div>
  </div>
</template>

<script>
  import DisplayUpdCreative         from "../../M81/prodDisplay/originality/DisplayUpdCreative"
  export default {
    name: "UpdCreativeFlow",
    components: {
      DisplayUpdCreative
    },
    props:{
