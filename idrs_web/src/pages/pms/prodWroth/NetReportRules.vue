  ...
  <div class="py-page">
    ...
    <div class="py-page-container">
      <div class="table-top-btns">
        <div class="left">
          <k-btn slot="button" class="btn-custom-primary" data-functype="POPUP" :data-handler="()=>this.formData={}" style="width:76px"
      ...
      <k-grid ref="NetReportRulesGrid" @data-row-select="selectRow" data-action="NetReportRules.findNetReportRules"
         data-operate-width="170px">
        <k-grid-column data-header="id" data-name="ID" data-hidden="true"/>
        <k-grid-column data-header="运作模式" data-name="operationMode" data-dict="operation_mode" />
        <k-grid-column data-header="规律开放周期" data-name="regularOpenCycle" data-dict="regular_open_cycle" />
        <k-grid-column data-header="报送规则" data-name="reportRules" data-dict="report_rules" />
        <k-grid-column data-header="报送频率" data-name="reportFreqVal" />
        ...
        <k-grid-column data-header="报送日期" data-name="specificDate" data-hidden="true"/>
        <k-grid-column data-header="报送日期" data-name="specificDateVal" />
        <k-grid-column data-header="报送估值日" data-name="reportDate" data-dict="report_date" />
        <k-grid-column data-header="月末是否报送" data-name="reportMonth" data-dict="1yes2no" />
        <k-grid-column data-header="确认日是否报送" data-name="reportConfirmDate" data-dict="1yes2no" data-hidden="true"/>
        <k-grid-column data-header="是否基准日期" data-name="isBaseDay" data-dict="1yes2no"/>
