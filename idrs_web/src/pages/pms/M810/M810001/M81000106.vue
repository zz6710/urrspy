<template>
  <k-form  ref="M81000106"  :data-col="2">
    ...
    <k-form-item label="托管场所" >
      <k-field-select  v-model="value.trusteeMarket" data-dict="t8_trustee_market" :data-allowblank="false"></k-field-select>
    </k-form-item>
    ...
    <k-form-footer data-align="center">
      <k-btn data-target="accountTable" data-functype="SUBMIT" class="btn-custom-primary" :data-model="value" data-action="T810001.updateAccountInfo" data-from="M81000106">
