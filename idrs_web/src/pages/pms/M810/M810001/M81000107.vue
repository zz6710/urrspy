<template>
  <k-form  ref="M81000107"  :data-col="2">
    ...
    <k-form-item label="基金交易对手" >
      <k-field-select  v-model="value.fundOside"  :data-allowblank="true"></k-field-select>
    </k-form-item>
    ...
    <k-form-footer data-align="center">
      <k-btn data-target="accountTable" data-functype="SUBMIT" class="btn-custom-primary" :data-model="value" data-action="T810001.updateAccountInfo" data-from="M81000107">
