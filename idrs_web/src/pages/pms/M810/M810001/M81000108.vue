<template>
  <k-form  ref="M81000108"  :data-col="2">
    ...
    <k-form-footer data-align="center">
      <k-btn data-target="accountTable" data-functype="SUBMIT" class="btn-custom-primary" :data-model="value" data-action="T810001.updateAccountInfo" data-from="M81000108">
