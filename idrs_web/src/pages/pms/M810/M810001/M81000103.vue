<template>
  <k-form  ref="M81000103"  :data-col="2">
    ...
    <k-form-footer data-align="center">
      <k-btn data-target="queryTable" data-functype="SUBMIT" class="btn-custom-primary" :data-model="value" data-action="T810001.addAccountInfo" data-from="M81000103">
