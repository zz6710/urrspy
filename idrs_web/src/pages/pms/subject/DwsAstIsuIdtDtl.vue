	...
	<div class="py-page">
		<div>
			<k-form-search-customize
				ref="searchRef"
				data-model-name="DwsAstIsuIdtDtl"
				data-label-width="80px"
				v-model="searchParam"
				data-target="dwsAstIsuIdtDtlGrid"
			>
		...
		<div class="py-page-container">
			<div class="table-top-btns">
				<div class="left">
					...
					<k-btn
						...
						data-target="dwsAstIsuIdtDtlGrid"
						data-export-name="企业债按行业、企业规模统计明细表"
			...
			<k-grid
				ref="dwsAstIsuIdtDtlGrid"
				@data-row-select="selectRow"
				data-action="DwsAstIsuIdtDtl.findDwsAstIsuIdtDtls"
				:data-autoload="false"
				data-dict-type="1"
			>
				...
				<k-grid-column data-header="发行人名称" data-name="isuOrgNm"></k-grid-column>
				<k-grid-column data-header="发行人行业" data-name="isuOrgIdt" data-dict="pbc_eco_inds_typ"></k-grid-column>
				<k-grid-column data-header="发行人规模" data-name="isuOrgVol" data-dict="pbc_enterprise_scale"></k-grid-column>
				<k-grid-column data-header="市值" data-name="mktVol"></k-grid-column>
				<template slot="operate" slot-scope="scope">
					<k-btn
						class="btn-custom-text"
						data-descript="修改企业债按行业、企业规模统计明细表"
						data-functype="POPUP"
						data-size="mini"
						data-target="editDwsAstIsuIdtDtlPopup"
					>修改</k-btn>
					<k-btn
						class="btn-custom-text"
						data-functype="SUBMIT"
						data-action="DwsAstIsuIdtDtl.deleteDwsAstIsuIdtDtl"
						data-size="mini"
						data-type="danger"
						data-target="dwsAstIsuIdtDtlGrid"
						:data-confirm="true"
						data-descript="删除企业债按行业、企业规模统计明细表"
					>删除</k-btn>
				</template>
			</k-grid>
		</div>

		<!--    修改企业债按行业、企业规模统计明细表弹出框   -->
		<k-popup ref="editDwsAstIsuIdtDtlPopup" data-title="修改">
			<k-form ref="editDwsAstIsuIdtDtlForm" :data-col="2">
				<k-form-item label="数据日期">
				...
				<k-form-item label="发行人名称" :class="[handleItemDiff('isuOrgNm')]">
					<k-field-text v-model="formData.isuOrgNm" />
				</k-form-item>
				<k-form-item label="发行人行业" :class="[handleItemDiff('isuOrgIdt')]">
					<k-field-select
						v-model="formData.isuOrgIdt"
						data-dict="pbc_eco_inds_typ"
						:data-dict-exclude-filter="['T', '1', '2']"
						data-dict-type="1"
					/>
				</k-form-item>
				<k-form-item label="发行人规模" :class="[handleItemDiff('isuOrgVol')]">
					<k-field-select
						v-model="formData.isuOrgVol"
						data-dict="pbc_enterprise_scale"
						data-dict-type="1"
					/>
				</k-form-item>
				...
				<k-form-footer data-align="center">
					<k-btn
						...
						data-functype="SUBMIT"
						data-action="DwsAstIsuIdtDtl.updateDwsAstIsuIdtDtl"
						data-from="editDwsAstIsuIdtDtlForm"
						:data-model="formData"
						data-target="dwsAstIsuIdtDtlGrid"
					>
			...
			<k-form ref="addNewForm" data-ui="element">
				...
				<k-form-item label="附件" data-ui="element" data-input-width="500px">
					<k-field-excel-upload
						...
						data-upload-url="upload/server/RptApp/uploadDwsAstIsuIdtDtl.json"
						data-tip-succ="导入成功"
					></k-field-excel-upload>
				</k-form-item>
				<k-form-footer data-align="center">
		...
		<!-- <GenerateFormAgainDialog ref="formAgainRef" paraid="90000052006" menuId="M061816" buttonName="重新生成报表" /> -->
...
export default {
	...
	methods: {
		...
		// 				async: true,
		// 				params: { menuId: "M061816", buttonName: "重新生成报表", reportDate: this.lastDay, paraid: "90000052006" },
		// 				successAlert: false,
		...
		onSubmitNewSuccess() {
			if (this.searchParam.reportDate) {
				this.$refs.dwsAstIsuIdtDtlGrid.load(this.searchParam);
			}
