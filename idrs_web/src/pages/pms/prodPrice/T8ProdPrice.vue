  ...
  <div>
    <k-form-search-customize data-target="priceGrid" v-model="queryParam">
      ...
      <k-btn slot="button" class="btn-custom-primary" data-functype="POPUP" data-target="addPopup" :data-handler="initFormData"
             v-if="global.isShowAuthorityButton('T8ProdPrice.addOrUpdateT8ProdPrice')">
...
<!--      <k-grid-column data-align="center" data-header="基准类型" data-name="baseType" hidden="true"/>-->
      ...
      <k-grid-column data-align="center" data-header="生效日期" data-name="validateDate"/>
      <k-grid-column data-align="center" data-header="失效日期" data-name="invalidateDate"/>
      <k-grid-column data-align="center" data-header="创建人" data-name="createUserName"/>
      <k-grid-column data-align="center" data-header="创建日期" data-name="createDate"/>
      <k-grid-column data-align="center" data-header="创建时间" data-name="createTime"/>
      <k-grid-column data-align="center" data-header="状态" data-name="confirmStatus" data-dict="confirm_status"/>
      <template slot="operate" slot-scope="scope">
        <k-btn data-functype="POPUP" data-size="mini" data-target="editPopup" :data-handler="getProdPriceInfo"
               v-if="global.isShowAuthorityButton('T8ProdPrice.updT8ProdPrice')"
               class="md-info md-just-icon md-simple"
               data-descript="修改业绩基准" :data-disabled="scope.row.row.confirmStatus>=1">
          <md-icon>edit</md-icon>
        </k-btn>
        <k-btn class="md-danger md-just-icon md-simple"
               data-functype="SUBMIT" v-if="global.isShowAuthorityButton('T8ProdPrice.deleteProdPrice')"
               data-action="T8ProdPrice.deleteProdPrice"
               data-size="mini"
               data-type="danger"
               data-target="priceGrid"
               :data-confirm="true"
               data-descript="删除业绩基准" v-show="showDelete" :data-disabled="scope.row.row.confirmStatus>=1">
    ...
    <k-popup ref="editPopup" data-title="修改" >
          ...
          <k-form class="my-form" :data-col="2" dataLabelWidth="170px" dataInputWidth="300px" ref="submitForm">
            ...
            <k-form-footer data-align="center">
              <k-btn class="btn-custom-primary" data-functype="SUBMIT" data-action="T8ProdPrice.addOrUpdateT8ProdPrice"
                     :data-model="priceData" data-target="priceGrid" ref="editBtn">
                <md-icon md-src="/static/svg/confirm.svg"></md-icon>确定
              </k-btn>
              <k-btn class="btn-custom-plain" data-functype="CLOSE">
                <md-icon md-src="/static/svg/cancel.svg"></md-icon>取消</k-btn>
...
<script>
  import AddComp from "./ProdPerformanceBenchmark"
