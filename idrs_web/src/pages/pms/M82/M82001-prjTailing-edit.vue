  ...
  <div>
    <k-form ref="editForm" :data-col="2">
      <k-form-item label="产品代码" data-input-width="600px">
          <k-field-select v-model="formData.prodCode" data-action="T8Dict.findTaProdInfos" :dataAllowblank="false"
            data-display-field="prodName"  data-value-field="prodCode" data-disabled/>
      </k-form-item>
      <k-form-item label="销售商代码" v-show="false">
          <k-field-text v-model="formData.distributorCode" :dataAllowblank="false" data-disabled />
      </k-form-item>
    ...
    <div>
        <k-form>
          <k-form-footer data-align="center">
            <k-btn data-functype="SUBMIT" data-action="T8PrjTailingCommision.updateTaPrjTailingCommision" data-from="addForm" :data-model="formData" data-target="T82001Grid"
