  ...
  <div>
    <div style="min-height:225px;">
      ...
      <k-grid id = "TaProdInterestGrid"
              ...
              data-action='T82010.findTa2010'
              @data-row-select="selectRow"
              @init="(grid)=>{this.$kgrid = grid}"
              data-operate-column-position="end"
              data-operate-width="300px"
              :data-autoload="false">
          <k-grid-column data-header="索引号" data-name="indexNo"  ></k-grid-column>
          <k-grid-column data-header="文件类型名称" data-name="indexName"  data-width="200px"  ></k-grid-column>
          <k-grid-column data-header="文件名称" data-name="nameRules" data-width="200px" ></k-grid-column>
          <k-grid-column data-header="是否导出" data-name="effectStatus"  data-dict="lyesOno"></k-grid-column>
          <k-grid-column data-header="索引文件类型" data-name="fileType"  data-dict="fileTypeTa"></k-grid-column>
        ...
        <template slot="operate">
          ...
          <k-btn data-functype="POPUP" data-confirm data-size="mini"   class="md-info md-just-icon md-simple"
                 data-target="updateTaIntfPopup" data-descript="修改索引文件" @submit.native.prevent>
            <md-icon>edit</md-icon>
          </k-btn>

          <k-btn data-functype="SUBMIT" data-size="mini" class="md-danger md-just-icon md-simple" data-descript="删除索引文件"
                 data-target="TaProdInterestGrid" data-action="T82010.deleteTa2010" data-confirm data-type="danger" >
    ...
    <k-popup ref="addPopup" data-title="新增">
      <k-form ref="addTaIntfForm" :data-col="2">
        ...
        <k-form-item label="索引号">
          <k-field-text v-model="rowData.indexNo"  ref="indexNo" :dataAllowblank='false' :data-max-length="32"/>
        </k-form-item>
        <k-form-item label="文件类型名称">
          <k-field-text v-model="rowData.indexName"  ref="indexName" :dataAllowblank='false' :data-max-length="100"/>
        </k-form-item>
        <k-form-item label="文件名称表达式">
          <k-field-text v-model="rowData.nameRules" ref="nameRules" :dataAllowblank='false' :data-max-length="100"/>
        </k-form-item>
        <k-form-item label="是否导出">
          <k-field-radio v-model="rowData.effectStatus"  data-dict="lyesOno" />
        </k-form-item>
       <k-form-item label="索引文件类型">
          <k-field-select v-model="rowData.fileType"  data-dict="fileTypeTa" :dataAllowblank='false'/>
        </k-form-item>
       <k-form-item label="数据源名称">
          <k-field-radio v-model="rowData.datasource" data-dict="datasourceTa" :dataAllowblank='false'/>
        </k-form-item>

        <k-form-footer data-align="center">
          <k-btn class="btn-custom-primary" data-functype="SUBMIT" data-action="T82010.addTa2010"
    ...
    <k-popup ref="updateTaIntfPopup" data-title="修改">
      <k-form ref="updateTaIntfForm" :data-col="2">
        ...
        <k-form-item label="索引号">
          <k-field-text v-model="rowData.indexNo"  ref="indexNo" :dataAllowblank='false' :data-max-length="32" :data-disabled="true"  />
        </k-form-item>
        <k-form-item label="文件类型名称">
          <k-field-text v-model="rowData.indexName"  ref="indexName" :data-max-length="100" :dataAllowblank='false'/>
        </k-form-item>
        <k-form-item label="文件名称">
          <k-field-text v-model="rowData.nameRules" ref="nameRules" :data-max-length="100" :dataAllowblank='false'/>
        </k-form-item>
        <k-form-item label="是否导出">
          <k-field-radio v-model="rowData.effectStatus"  data-dict="lyesOno" :dataAllowblank='false'/>
        </k-form-item>
        <k-form-item label="索引文件类型">
          <k-field-select v-model="rowData.fileType"  data-dict="fileTypeTa" />
        </k-form-item>
        <k-form-item label="数据源名称">
          <k-field-radio v-model="rowData.datasource" data-dict="datasourceTa" />
        </k-form-item>

        <k-form-footer data-align="center">
          <k-btn class="btn-custom-primary" data-functype="SUBMIT" data-action="T82010.updateTa2010"
