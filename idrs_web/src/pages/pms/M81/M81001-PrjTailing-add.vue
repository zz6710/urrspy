  ...
  <div>
    <k-form ref="addForm" :data-col="2">
      ...
      <k-form-item label="启用日期">
        <k-field-date v-model="formData.enableDate" :dataAllowblank="false" :dataMinValue="this.currentWorkday"/>
      </k-form-item>
    ...
    <div>
      <k-form>
        <k-form-footer data-align="center">
          <k-btn data-functype="SUBMIT" data-action="T8PrjTailingCommision.addTaPrjTailingCommisionByProdCode"
          data-from="addForm" :data-model="formData" data-target="T82001Grid" :data-handler="beforeSubmit" class="btn-custom-primary">
...
<script>
  ...
  export default {
    ...
    created() {
      this.formData.prodCode = this.$attrs.value.prodCode;
    ...
    methods: {
      beforeSubmit : function(value){
        ...
        if(isCommit){
          ...
          value.prodCode = this.formData.prodCode;
        }else{
