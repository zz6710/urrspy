<template>
    <div>
        ...
        <div style="min-height:225px;">
            ...
            <k-grid ref="T82001Grid" data-action="T8PrjTailingCommision.findTaPrjTailingCommisionsByProdCode"  id="T82001Grid" :data-autoload="false"
                ...
                <k-grid-column data-header="计提方式" data-name="tailingCalcMode"  data-width="100"
                data-dict="tailing_calc_mode"></k-grid-column>
...
<script>
    ...
    import AddComp from "./M81001-PrjTailing-add"
    import EditComp from "./M81001-PrjTailing-edit"
    ...
    export default {
        ...
        watch: {
            'gridQueryData.distributorCode'(value){
                this.$kgrid.load(this.gridQueryData);
            },
            prodCode(value){
                if(value != ''){
