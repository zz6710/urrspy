...
<!--        </el-button>-->
        ...
        <el-button style="margin-right:18px" @click="saveWorkdays" type="success" icon="el-icon-check"
                   :disabled="saveLoading" size="mini">
          <i v-show="saveLoading" class="el-icon-loading"/>
          <span v-show="!saveLoading" >保存</span>
        </el-button>
    ...
    methods: {
      ...
      saveWorkdays() {
        ...
        this.httpUtil.comnUpdate({
          ...
          // TODO
          params: {
            "t8ProdInfoId": String(this.prodInfoId),
            "prodCode": String(this.prodCode),
            "changeDate": this.action.workdays,
            "dateType":"1",
            "adjustReason":this.fromData.adjustReason,
            "fromData" : JSON.stringify(this.fromData),
            "pgmno":this.pgmno,
          },
          mask: true,
