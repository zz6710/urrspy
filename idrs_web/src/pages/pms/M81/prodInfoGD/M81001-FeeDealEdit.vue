    ...
    <k-form ref="editForm" :data-col="2">
      ...
      <k-form-item label="交易费用类型" >
        <k-field-select v-model="ProdFeeDealInfo.feeTypeDeal" data-dict="t8_fee_type_deal" @data-on-change="changeSelectValue"
                        :data-allowblank="false" :data-disabled="prodMode=='1'" />
      </k-form-item>
      ...
      <k-form-item label="最高费用">
        <k-field-text v-model="ProdFeeDealInfo.maxCost" data-type="money" :data-max-length="19" data-digits="2"
                      ...
                      data-min-value="ProdFeeDealInfo.minCost"/>
      </k-form-item>
      <k-form-item label="最低费用">
        <k-field-text v-model="ProdFeeDealInfo.minCost" data-type="money" :data-max-length="19" data-digits="2"
                      data-integer-length="16"  data-validate-type="money"  data-show-gbmoney="true"
                      data-max-value="ProdFeeDealInfo.maxCost"/>
      </k-form-item>
      <k-form-item label="是否按金额分段" v-if="false">
        <k-field-select v-model="ProdFeeDealInfo.isAmtSegment" data-default-value="" data-dict="t8_prod_isok"/>
      </k-form-item>
      <k-form-item label="是否按时间分段" v-if="false">
        <k-field-select v-model="ProdFeeDealInfo.isTimeSegment" data-dict="t8_prod_isok"/>
      </k-form-item>
    </k-form>
    <div class="my-container" style="margin-top:30px;">
      <div class="my-item2" v-show="ProdFeeDealInfo.feeTypeDeal !='3'">
        ...
        <div class="my-item2-chips">
          <md-chips v-model="moneyList" class="md-primary" style="padding-top: 4px !important;" md-placeholder="请输入分段金额,并按回车确认"  md-input-type="number"
                    @md-delete="deleteMoney" @md-insert="insertMoney"  v-show="switchSegmentValue" ></md-chips>
        </div>
      </div>
      <div class="my-item3" v-show="prodMode!='1' && ProdFeeDealInfo.feeTypeDeal =='3'">
        ...
        <div class="my-item2-chips" >
          <md-chips v-model="timeList" class="md-primary" style="padding-top: 4px !important;" md-placeholder="请输入分段天数,并按回车确认" md-input-type="number"
                    @md-delete="deleteTime" @md-insert="insertTime"  v-show="switchTimeValue" ></md-chips>
        </div>
      </div>
    </div>
...
<!--                        v-show="ProdFeeDeal3.chargeType=='1'"></md-input>-->
              <md-input class="md-input" style="width: 80px; text-align: right;" v-model="item.constantFee" md-input-type="number" v-show="ProdFeeDeal3.chargeType=='0'||ProdFeeDeal3.chargeType==''"></md-input>
    ...
    <div>
      <k-form>
        <k-form-footer data-align="center">
          <k-btn class="btn-custom-primary" data-functype="SUBMIT"  data-from="editForm"
                 :data-handler="beforeSubmit" :data-model="ProdFeeDealInfo" data-target="t8FeeDealGrid">
