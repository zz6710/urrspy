...
<!--              <div class="head-tips">i</div>-->
    ...
    <div class="form-foot">
      <k-btn class="btn-custom-primary" data-functype="SUBMIT" data-action="T8ProdSelectAssembly.addAssemblyProdInfoList" style="margin-right: 4px;"
             :data-model="formData" :data-handler="confirmHandler" data-target="prodInfoGrid">
...
//      taskInfos: [],
    ...
    methods: {
      ...
      confirmHandler:function(params){
        ...
        params["prodCode"] = this.modValue.prodCode;
        params["isShareSort"] = this.modValue.isShareSort;
        return params;
      },
    ...
    mounted() {
      this.httpUtil.comnQuery({
        action: 'T8ProdAssembly.findAssemblyProdInfo',
        params: {prodCode:this.modValue.prodCode,prodMode:this.modValue.prodModeId}
      }).then(data => {
      ...
      //查询该组已经配置的组件
      this.httpUtil.comnQuery({
        action: 'T8ProdAssembly.findAssemblyProdInfoAdd',
        params: {prodCode:this.modValue.prodCode,prodMode:this.modValue.prodModeId}
      }).then(data => {
