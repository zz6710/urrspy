      ...
      queryProdCalendar(view) {
        ...
        this.httpUtil.comnQuery({
          ...
          rows_.forEach(event => {
            ...
            if (event.parameterConfirmDate == '1') {
              this.putEvents2Lst(event, '参数确认', 'event-subs ', '/main/pms/M81/prodConfirm/ProdMeetingList')
            }

            if (event.declareDate == '1') {
              this.putEvents2Lst(event, '  申报', 'event-value ', '/main/pms/M84/M84015')
            }

            if (event.issueDate == '1') {
              this.putEvents2Lst(event, '  发行', 'event-clear ', '/main/pms/M84/M84015')
            }
            ...
            if (event.applyDate == '1' && event.prodMode!='2' && event.prodMode!='4') {
              this.putEvents2Lst(event, '预约申购', 'event-apply ', '/main/pms/M84/M84015')
            }

            if (event.registerDate == '1') {
              this.putEvents2Lst(event, '红利发放', 'event-register ', '/main/pms/prod/dividendPlan')
            }
            ...
            //
            // if (event.redeemAckDate == '1'){
            //   this.putEvents2Lst(event, '赎回确认', 'event-redeem ', '/main/TA/TA1/T81007')
            // }
            //
            // if (event.registerDate == '1'){
            //   this.putEvents2Lst(event, '分红登记', 'event-register ', '/main/TA/TA1/T81004')
            // }
            //
            // if (event.convertDate == '1'){
            //   this.putEvents2Lst(event, '收益结转', 'event-pay ', '/main/TA/TA1/T81007')
            // }
            //
            // if (event.endDate == '1'){
            //   this.putEvents2Lst(event, '  到期', 'event-winding ', '/main/TA/TA1/T81007')
            // }
            //
            // if (event.windingDate == '1'){
            //   this.putEvents2Lst(event, '  清算', 'event-clear ', '/main/TA/TA1/T81007')
            // }
            //
            // if (event.payDate == '1'){
            //   this.putEvents2Lst(event, '  兑付', 'event-pay ', '/main/TA/TA1/T81007')
            // }
