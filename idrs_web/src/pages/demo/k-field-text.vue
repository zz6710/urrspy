<template>
  <div>
    ...
    <k-field-code>
      <textarea>
              <k-field-text v-model="value"  @data-on-change="handleChange"></k-field-text>
          </textarea>
    </k-field-code>
    ...
    <k-form
      ...
      :data-model="fromData"
    >
      <k-form-item label="文本框">
        <k-field-text
          v-model="fromData.textVal"
          :data-placeholder="fromData.dataPlaceholder"
          :data-validate-type="fromData.dataValidateType"
        ></k-field-text>
      </k-form-item>
       <k-form-item label="正则校验">
        <k-field-text
