<template>
  <div class="widget-param">
    <el-dialog title="修改tabPane字段" :visible.sync="showDialog" width="50%" :modal='false'>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="自定义标签页">
              <el-input placeholder="" v-model="element.options.icon.value" class="input-with-select">
                <template slot="prepend">{{element.options.icon.type}}</template>
                <el-button slot="append" @click="openSelectIcon">选择</el-button>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="element.selectOptions.indexOf('label') > -1">
            <el-form-item label="选项卡标题">
              <el-input v-model="element.options.label"></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12" v-if="element.selectOptions.indexOf('closable') > -1">
            <el-form-item label="标签是否可关闭">
              <el-select v-model="element.options.closable" placeholder="请选择" style="width:100%">
                <el-option label="是" :value="true"></el-option>
                <el-option label="否" :value="false"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="element.selectOptions.indexOf('lazy') > -1">
            <el-form-item label="	标签是否延迟渲染">
              <el-select v-model="element.options.lazy" placeholder="请选择" style="width:100%">
                <el-option label="是" :value="true"></el-option>
                <el-option label="否" :value="false"></el-option>
              </el-select>
            </el-form-item>
