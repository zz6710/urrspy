<template>
  ...
  >
    <el-form ref="form" :model="element" label-position="top" label-width="80px">
      <el-form-item label="查询条件Model(dataModelName)">
        <el-input v-model="element.options.dataModelName"></el-input>
      </el-form-item>
      <el-form-item label="表格ref(dataTarget)">
...
export default {
  components: {
    Draggable,KCodeEditor,FormCustomAttr
  },
  ...
  created (){
    this.element.selectOptions = ['dataModelName','dataTarget']
  },
  mounted () {
