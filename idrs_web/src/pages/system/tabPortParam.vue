<template>
  <div class="tab-page">
    <k-form-search data-target="PortParamGrid" data-model-name="SystemParam"  data-label-width="70px" />

    <k-grid ref="PortParamGrid" data-action='SystemParam.findPortParams' :data-autoload="true" :dataPopupAppendToBody="true"
...
<!--      <k-grid-column data-header="分组ID" data-name="groupparaid"></k-grid-column>-->
      ...
      <template slot="operate">
        <k-btn data-functype="POPUP" data-confirm data-size="mini" class="md-info md-just-icon md-simple"
               data-target="editPortParamPopup" data-descript="修改参数" v-if="global.isShowAuthorityButton('SystemParam.updateSysParam')">
    ...
    <!--   修改   -->
    <k-popup ref="editPortParamPopup" data-title="修改">
      <k-form ref="editPortParamForm" :data-col="2">
        ...
        <k-form-footer data-align="center">
          <k-btn class="btn-custom-primary" data-functype="SUBMIT" data-action="SystemParam.updateSysParam"
                 data-from="editPortParamForm" :data-model="formData" :data-handler="changeConfigOptionToStr"
                 data-target="PortParamGrid">
