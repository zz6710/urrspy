<template>
  <div class="py-page">
     <div>
        <k-form-search-customize data-model-name="AppNavInfoRegErr" data-target="AppNavInfoRegErrGrid"  v-model = "searchParam">
    ...
    <div class="py-page-container">
      <k-grid ref="AppNavInfoRegErrGrid" @data-row-select="selectRow"  data-operate-column="false" data-action="AppNavInfoRegErr.findAppNavInfoRegs" >
