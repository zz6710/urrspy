<template>
  <div class="py-page">
     <div>
        <k-form-search-customize data-model-name="AppNavReg" data-target="AppNavRegGrid"  v-model = "searchParam">
              ...
              <k-form-item label="净值登记日期">
                <k-field-date v-model="SearchNveDay" data-type="daterange" data-date-format="yyyyMMdd" data-value-format="yyyyMMdd"/>
              </k-form-item>
        </k-form-search-customize>
     </div>

    <div class="py-page-container">
      <k-grid ref="AppNavRegGrid" @data-row-select="selectRow"  data-operate-column="false" data-action="AppNavReg.findAppNavInfoRegs" >
          <k-grid-column data-align="left" data-header="操作人员" data-name="summitUser" data-width="100"></k-grid-column>
          <k-grid-column data-align="left" data-header="操作日期" data-name="createDate"  data-sortable="true"   data-width="100"></k-grid-column>
          <k-grid-column data-align="left" data-header="操作时间" data-name="createTime" data-type="time" data-width="60"  data-sortable="true"  ></k-grid-column>
  ...
  export default {
    ...
    watch: {
      BreathDay() {
        ...
        this.$set(this.searchParam, 'optStartDate', this.BreathDay == null ? '' : this.BreathDay[0]);
        this.$set(this.searchParam, 'optEndDate', this.BreathDay == null ? '' : this.BreathDay[1]);
      },
      SearchNveDay() {

        this.$set(this.searchParam, 'navBeginDate', this.SearchNveDay == null ? '' : this.SearchNveDay[0]);
        this.$set(this.searchParam, 'navEndDate', this.SearchNveDay == null ? '' : this.SearchNveDay[1]);
      },
    }
  };
</script>
