<template>
  <div class="py-page">
    <div>
       <k-form-search-customize data-model-name="ProdRegistFilingInfoh" data-target="ProdRegistFilingInfohGrid" v-model = "searchParam">
            <k-form-item label="登记日期">
              ...
              <k-form-item label="产品品牌">
                <k-field-select v-model="searchParam.prodBrand"  :data-data="formData.addProdBrandDict"  data-value-field="VALUE" data-display-field="TEXT"/>
              </k-form-item>
       </k-form-search-customize>
    </div>
    <div class="py-page-container">
      <k-grid ref="ProdRegistFilingInfohGrid" @data-row-select="selectRow"  data-operate-column="false" data-action="ProdRegistFilingInfoh.findProdRegistFilingInfos" >
        ...
        <k-grid-column data-align="left" data-header="产品收益类型" data-name="prodRetrunType" data-dict="prod_revenue_type" data-width="130"></k-grid-column>
        <k-grid-column data-align="left" data-header="新老产品标记" data-name="newProd" data-dict="newProd" data-width="100"></k-grid-column >
        <k-grid-column data-align="left" data-header="产品期限" data-name="prodTerm" data-dict="t8_prod_term" data-width="120"></k-grid-column>
        <k-grid-column data-align="left" data-header="是否金融同业专属" data-name="fiancialExclusive" data-dict="isTrue" data-width="100"></k-grid-column>
        <k-grid-column data-align="left" data-header="资金投向地区" data-name="invertRegion" data-dict="invest_region" data-width="100"></k-grid-column>
        ...
        <k-grid-column data-align="left" data-header="理财业务服务模式" data-name="serviceMode" data-dict="t8_srv_mode" data-width="120"></k-grid-column>
        <k-grid-column data-align="left" data-header="产品运作模式" data-name="operationMode" data-dict="t8_product_operation_mode" data-width="120"></k-grid-column>
        <k-grid-column data-align="left" data-header="产品募集方式" data-name="typeCollect" data-dict="t8_raise_type"  data-width="120"></k-grid-column>
        <k-grid-column data-align="left" data-header="产品资产配置方式" data-name="assetAcMethod" data-dict="t8_asset_maping" data-width="155"></k-grid-column>
        <k-grid-column data-align="left" data-header="产品管理模式" data-name="prodManaMode" data-dict="prod_manage_mode" data-width="140"></k-grid-column>
        <k-grid-column data-align="left" data-header="实际管理人名称" data-name="acManaName" data-width="120"></k-grid-column>
        <k-grid-column data-align="left" data-header="产品定价方式" data-name="priceMethod" data-dict="prod_price_way" data-width="100"></k-grid-column>
        <k-grid-column data-align="left" data-header="产品投资性质" data-name="investType" data-dict="prod_invest_nature" data-width="100"></k-grid-column>
        <k-grid-column data-align="right" data-header="业绩比较基准%" data-name="prodBenchmark" data-width="100"></k-grid-column>
        <k-grid-column data-align="left" data-header="是否设置最短持有期限" data-name="minHoldPeriod" data-dict="isTrue" data-width="100"></k-grid-column>
        <k-grid-column data-align="right" data-header="最短持有期限（天）" data-name="minHoldDay" data-width="100"></k-grid-column>
        <k-grid-column data-align="left" data-header="最短持有期后是否自由赎回" data-name="optionRedemptPeriod" data-dict="optionRedemptPeriod" data-width="100"></k-grid-column>
        <k-grid-column data-align="left" data-header="是否现金管理类" data-name="cashManager" data-dict="isTrue" data-width="100"></k-grid-column>
        ...
        <k-grid-column data-align="left" data-header="募集币种" data-name="fundCur" data-dict="cur_type" data-width="100"></k-grid-column>
        <k-grid-column data-align="left" data-header="兑付本金币种" data-name="principalCur" data-dict="cur_type" data-width="100"></k-grid-column>
        <k-grid-column data-align="left" data-header="兑付收益币种" data-name="incomeCur" data-dict="cur_type" data-width="100"></k-grid-column>
        ...
        <k-grid-column data-align="left" data-header="境内托管机构名称" data-name="dcCdName" data-dict="domestic_custodian_name" data-width="200"></k-grid-column>
        ...
        <k-grid-column data-align="left" data-header="投资者风险偏好" data-name="riskLevel" data-dict="investor_risk_preference" data-width="100"></k-grid-column>
        <k-grid-column data-align="left" data-header="产品风险等级" data-name="riskRate" data-dict="prod_risk_level" data-width="120"></k-grid-column>
        <k-grid-column data-align="left" data-header="发行机构提前终止权标识" data-name="earlyTnOption" data-dict="prod_credit_logo" data-width="100"></k-grid-column>
        <k-grid-column data-align="left" data-header="客户赎回权标识" data-name="investRdmOption" data-dict="prod_credit_logo" data-width="100"></k-grid-column>
        ...
        <k-grid-column data-align="left" data-header="产品特殊属性" data-name="prodEspPrpt"  data-dict="prodEspPrpt" data-width="130"></k-grid-column>
        <k-grid-column data-align="right" data-header="投资管理费率%" data-name="manageFeeRate" data-width="100"></k-grid-column>
        <k-grid-column data-align="left" data-header="合作模式" data-name="cooperateMode" data-dict="cooperation_mode" data-width="100"></k-grid-column>
        <k-grid-column data-align="left" data-header="合作机构名称" data-name="cooperator" data-width="100"></k-grid-column>
        <k-grid-column data-align="left" data-header="投资本金到账日" data-name="principalDueDate"  data-dict="invest_income_arrive_date" data-width="100"></k-grid-column>
        <k-grid-column data-align="left" data-header="投资收益到账日" data-name="incomeDueDate" data-dict="invest_income_arrive_date" data-width="100"></k-grid-column>
        <k-grid-column data-align="left" data-header="产品增信标识" data-name="prodCrtEnhance" data-dict="prod_credit_logo" data-width="100"></k-grid-column>
        <k-grid-column data-align="left" data-header="产品增信机构类型" data-name="crtInsType" data-dict="prod_credit_type" data-width="100"></k-grid-column>
        <k-grid-column data-align="left" data-header="产品增信形式" data-name="prodCrtMethod"  data-dict="prod_credit_form" data-width="100"></k-grid-column>
