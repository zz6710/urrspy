<template>
  <div class="py-page">
    <div>
      <k-form-search-customize data-model-name="AssetRegistInfo"  data-target="AssetRegistInfoGrid" data-label-width="130px" v-model="searchParam" ref="searchRef">
    ...
    <div class="py-page-container">
      <div class="table-top-btns">
        <div class="left">
          <k-btn slot="button"  class="btn-custom-plain"  data-functype="EXPORT" data-target="AssetRegistInfoGrid" data-export-dict="true" data-export-form="searchRef"
      ...
      <k-grid ref="AssetRegistInfoGrid" @data-row-select="selectRow" data-operate-column="false" data-fixed="right"  data-action="AssetRegistInfo.findAssetRegistInfos_day" :data-autoload="false" >
    ...
    <!--    修改资产持仓管理弹出框   -->
    <k-popup ref="editAssetRegistInfoPopup" data-title="修改">
      <k-form ref="editAssetRegistInfoForm" :data-col="2" isFormBodyScreen>
        ...
        <k-form-item label="中间层行内资产/负债编码" :class="[handleItemDiff('mezzanineAssetCode')]">
          <k-field-text v-model="formData.mezzanineAssetCode" :data-allowblank="formDataMust.mezzanineAssetCode" :data-max-length="200"/>
        </k-form-item>
        <k-form-item label="会计科目名称" :class="[handleItemDiff('accountCode')]">
          <k-field-text v-model="formData.accountCode" :data-allowblank="formDataMust.accountCode" :data-max-length="200"/>
        </k-form-item>
    ...
    <k-popup ref="uploadAssetRegistInfoPopup" title="数据导入">
      <k-form ref="addForm" data-ui="element">
        <k-form-item label="理论报送起始日期">
          <k-field-date v-model="uploadBeginDate"   data-date-format="yyyy-MM-dd"  data-value-format="yyyyMMdd" :data-allowblank="false"/>
        </k-form-item>
