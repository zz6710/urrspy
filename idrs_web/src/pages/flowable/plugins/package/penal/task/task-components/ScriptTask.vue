<template>
  <div style="margin-top: 16px">
    <el-form-item label="脚本格式">
      <el-select v-model="scriptTaskForm.scriptFormat" clearable @input="updateElementTask()" @change="updateElementTask()">
...
<script>
import { scriptType } from "../../listeners/utilSelf";
export default {
	name: "ScriptTask",
	props: {
		id: String,
	...
	methods: {
		resetTaskForm() {
			...
			this.$set(this.scriptTaskForm, "scriptType", "inline");
		},
		updateElementTask() {
