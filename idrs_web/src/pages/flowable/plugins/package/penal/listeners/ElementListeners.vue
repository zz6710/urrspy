<template>
  <div class="panel-tab__content">
    <el-table :data="elementListenersList" size="mini" border>
      <el-table-column label="事件类型" min-width="90px" prop="event" :formatter="row => listenerEventTypeObject[row.event]" />
...
import { initListenerType, initListenerForm, listenerType, fieldType, scriptType } from "./utilSelf";
