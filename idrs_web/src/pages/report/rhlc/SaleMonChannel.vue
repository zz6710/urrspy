<template>
	<div class="py-page">
		<div>
			<k-form-search-customize data-model-name="SaleMonChannel" v-model="searchParam" data-target="saleMonChannelGrid">
				...
				<k-form-item label="销售机构代码">
					<k-field-text v-model="searchParam.saleOrgCode" />
				</k-form-item>
		...
		<div class="py-page-container">
			<div class="table-top-btns">
				<k-btn
					...
					data-target="saleMonChannelGrid"
					:data-export-name="'销售月度统计-分销售渠道_' + searchParam.reportDate"
					data-functype="EXPORT"
					data-size="small"
					data-url="SaleMonChannel.findSaleMonChannels" data-excel-template ="销售月度统计-分销售渠道.xlsx" data-excel-start-line ="3" data-template-name="销售月度统计-分销售渠道导出"
				>
					<md-icon>cloud_download</md-icon>
					导出
				</k-btn>
			</div>
			<k-grid ref="saleMonChannelGrid" @data-row-select="selectRow" data-action="SaleMonChannel.findSaleMonChannels" :dataOperateColumn="false" :data-autoload="false">
				<k-grid-column data-header="理财公司理财业务销售数据月度统计表-分销售渠道" dataAlign="center">
					<k-grid-column data-header="单位：个、人民币万元" dataAlign="right">
						<k-grid-column data-header="*产品登记编码" data-name="prodRegEnc"></k-grid-column>
						<k-grid-column data-header="*是否代销" data-name="saleProxy"></k-grid-column>
						<k-grid-column data-header="*销售机构代码" data-name="saleOrgCode"></k-grid-column>
