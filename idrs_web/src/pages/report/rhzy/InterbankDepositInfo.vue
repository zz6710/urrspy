<template>
	<div class="py-page">
		<div>
			<k-form-search-customize ref="searchRef" data-model-name="InterbankDepositInfo" v-model="searchParam" data-target="tableGrid">
		...
		<div class="py-page-container">
			<div class="table-top-btns">
				<div class="left">
					<k-btn ref="assetSend" slot="button" class="btn-custom-plain" data-size="small" @click="creatZipFile('CLTYCK')">
					...
					<k-btn
						...
						:data-export-name="getFileName('CLTYCK')"
			...
			<k-grid
				...
				data-fixed="right"
				data-action="InterbankDepositInfo.findInterbankDepositInfos"
			...
			>
				...
				<k-grid-column data-header="存款余额" data-name="depositBalance" data-width="140"></k-grid-column>
				<k-grid-column data-header="存款余额折人民币" data-name="depositBalanceRmb" data-width="140"></k-grid-column>
				<k-grid-column data-header="利率水平" data-name="rateLevel" data-width="140"></k-grid-column>
				<k-grid-column data-header="缴存准备金方式" data-name="depositType" data-width="140" data-dict="deposit_reserve_type"></k-grid-column>
				<template slot="operate" slot-scope="scope">
					<k-btn class="btn-custom-text" data-descript="修改存量同业存款信息" data-functype="POPUP" data-size="mini" data-target="editPopup">
						修改
					</k-btn>
					<k-btn
						class="btn-custom-text"
						data-functype="SUBMIT"
						data-action="InterbankDepositInfo.deleteInterbankDepositInfo"
						data-size="mini"
						data-type="danger"
						data-target="tableGrid"
						:data-confirm="true"
						data-descript="删除存量同业存款信息"
					>
						删除
					</k-btn>
				</template>
			...
			<k-form ref="addForm" data-ui="element">
				...
				<k-form-item label="报送数据导入" data-ui="element" data-input-width="500px">
					<k-field-excel-upload
						...
						data-upload-url="/upload/server/RptApp/rhzy/uploadInterbankDepositInfo.json"
					>
					</k-field-excel-upload>
				</k-form-item>
		...
		<k-popup ref="editPopup" data-title="修改">
			<k-form ref="editForm" :data-col="2" data-label-width="150px">
				...
				<k-form-item label="存款余额">
					<k-field-text v-model="formData.depositBalance" :data-allowblank="false" />
				</k-form-item>
				<k-form-item label="存款余额折人民币">
					<k-field-text v-model="formData.depositBalanceRmb" :data-allowblank="false" />
				</k-form-item>
				<k-form-item label="利率水平">
					<k-field-text v-model="formData.rateLevel" :data-allowblank="false" />
				</k-form-item>
				<k-form-item label="缴存准备金方式">
					<k-field-select v-model="formData.depositType" data-dict="deposit_reserve_type" data-dict-type="1" :data-allowblank="false" />
				</k-form-item>
				<k-form-footer data-align="center">
					<k-btn
						class="btn-custom-primary"
						data-functype="SUBMIT"
						data-action="InterbankDepositInfo.updateInterbankDepositInfo"
						data-from="editForm"
						:data-model="formData"
						data-target="tableGrid"
					>
