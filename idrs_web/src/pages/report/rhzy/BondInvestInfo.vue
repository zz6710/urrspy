<template>
	<div class="py-page">
		<div>
			<k-form-search-customize ref="searchRef" data-model-name="BondInvestInfo" data-label-width="80px" v-model="searchParam" data-target="tableGrid">
				...
				<k-form-item label="债券代码">
					<k-field-text v-model="searchParam.bondCode" />
				</k-form-item>
		...
		<div class="py-page-container">
			<div class="table-top-btns">
				<div class="left">
					<k-btn ref="assetSend" slot="button" class="btn-custom-plain" data-size="small" @click="creatZipFile('CLZQTZ')">
					...
					<k-btn
						...
						:data-export-name="getFileName('CLZQTZ')"
			...
			<k-grid
				...
				data-action="BondInvestInfo.findBondInvestInfos"
				:data-autoload="false"
			...
			>
				...
				<k-grid-column data-header="债券余额" data-name="bondBalance"></k-grid-column>
				<k-grid-column data-header="债券余额折人民币" data-name="bondBalanceRmb" data-width="150"></k-grid-column>
				...
				<template slot="operate" slot-scope="scope">
					...
					<k-btn
						...
						data-action="BondInvestInfo.deleteBondInvestInfo"
						data-size="mini"
						data-type="danger"
						data-target="tableGrid"
						:data-confirm="true"
			...
			<k-form ref="addForm" data-ui="element">
				...
				<k-form-item label="报送数据导入" data-ui="element" data-input-width="500px">
					<k-field-excel-upload
						...
						data-upload-url="/upload/server/RptApp/rhzy/uploadBondInvestInfo.json"
					>
					</k-field-excel-upload>
				</k-form-item>
		...
		<k-popup ref="editPopup" data-title="修改">
			<k-form ref="editForm" :data-col="2" data-label-width="150px">
				...
				<k-form-item label="债券余额">
					<k-field-text v-model="formData.bondBalance" :data-allowblank="false" />
				</k-form-item>
				<k-form-item label="债券余额折人民币">
					<k-field-text v-model="formData.bondBalanceRmb" :data-allowblank="false" />
				</k-form-item>
				<k-form-item label="债权债务登记日">
					<k-field-text v-model="formData.debtRegDate" :data-allowblank="false" />
				</k-form-item>
				<k-form-item label="起息日">
					<k-field-text v-model="formData.valueDate" :data-allowblank="false" />
				</k-form-item>
				<k-form-item label="兑付日期">
					<k-field-text v-model="formData.redemDate" />
				</k-form-item>
				...
				<k-form-footer data-align="center">
					<k-btn
						class="btn-custom-primary"
						data-functype="SUBMIT"
						data-action="BondInvestInfo.updateBondInvestInfo"
						data-from="editForm"
						:data-model="formData"
						data-target="tableGrid"
					>
