<template>
  <div class="page">
    <div :id="pageId" class="graph-container" style="position: relative;margin-left: 200px;"></div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      init() {
        ...
        let processData=this.data.hasOwnProperty("processData")?this.data.processData:{}
