  ...
  <div>
    <k-form-search-customize data-target="grid" v-model="queryParam">
      <k-form-item label="发起人">
        <k-field-text v-model="queryParamApplyUser"/>
      </k-form-item>
    ...
    <k-grid
      ...
      :data-display="false"
      data-url='/wf/processInstance/list.json'>
      ...
      <template slot="operate" slot-scope="scope">
        ...
        <k-btn class="md-info md-just-icon md-simple" data-descript="一键审批"  data-functype="POPUP" data-size="mini"
               data-target="uploadFilePopup" :data-disabled="!scope.row.row.taskId">
