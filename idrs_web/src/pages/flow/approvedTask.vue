<template>
  ...
  <div>
    ...
    <k-grid
            ...
            :data-display="false"
            data-url='/wf/businessProcess/queryProcessApproved.json' :data-params="{'operator':userid}">
      ...
      <template slot="operate" slot-scope="{row}">
        <k-btn class="btn-custom-plain" data-descript="详情" data-functype="POPUP" data-size="mini"
               data-target="detailPopup" @click="getDetailList(row.row)">
          详情
        </k-btn>
        <k-btn class="btn-custom-plain" data-descript="审批单下载" data-functype="POPUP" data-size="mini"
...
<script>
  ...
  export default {
    ...
    components: {
      ...
      OpFlowDetail,
      FlowCommentReadonly,
      PersonTree, FlowComment, FlowProcessInstanceListDialog,KFlowShow,VabOnlyOffice},
    data() {
      return {
        formData: {},
        selectRowData: {},
    ...
    methods: {
      ...
      getDetailList(row){
        ...
        console.log('this.commentParams',this.commentParams)
